// https://www.terraform.io/docs/providers/google-beta/r/google_pubsub_topic.html
...
export interface GooglePubsubTopicConfig extends TerraformMetaArguments {
...
export class GooglePubsubTopic extends TerraformResource {
  ...
  private _messageStoragePolicy?: GooglePubsubTopicMessageStoragePolicy[];
  public get messageStoragePolicy() {
    return this._messageStoragePolicy;
  }
  public set messageStoragePolicy(value: GooglePubsubTopicMessageStoragePolicy[] | undefined) {
    this._messageStoragePolicy = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GooglePubsubTopicTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GooglePubsubTopicTimeouts | undefined) {
