// https://www.terraform.io/docs/providers/google-beta/r/google_kms_key_ring_import_job.html
...
export interface GoogleKmsKeyRingImportJobConfig extends TerraformMetaArguments {
...
export class GoogleKmsKeyRingImportJobAttestation extends ComplexComputedList {
...
export class GoogleKmsKeyRingImportJobPublicKey extends ComplexComputedList {
...
export class GoogleKmsKeyRingImportJob extends TerraformResource {
  ...
  public attestation(index: string) {
    return new GoogleKmsKeyRingImportJobAttestation(this, 'attestation', index);
  }
  ...
  public publicKey(index: string) {
    return new GoogleKmsKeyRingImportJobPublicKey(this, 'public_key', index);
  }
  ...
  private _timeouts?: GoogleKmsKeyRingImportJobTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleKmsKeyRingImportJobTimeouts | undefined) {
