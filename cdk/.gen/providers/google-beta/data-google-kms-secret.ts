// https://www.terraform.io/docs/providers/google-beta/r/data_google_kms_secret_a.html
...
export interface DataGoogleKmsSecretAConfig extends TerraformMetaArguments {
...
export class DataGoogleKmsSecretA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleKmsSecretAConfig) {
    super(scope, id, {
