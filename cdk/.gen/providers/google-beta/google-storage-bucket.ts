// https://www.terraform.io/docs/providers/google-beta/r/google_storage_bucket.html
...
export interface GoogleStorageBucketConfig extends TerraformMetaArguments {
  ...
  /** cors block */
  readonly cors?: GoogleStorageBucketCors[];
  /** encryption block */
  readonly encryption?: GoogleStorageBucketEncryption[];
  /** lifecycle_rule block */
  readonly lifecycleRule?: GoogleStorageBucketLifecycleRule[];
  /** logging block */
...
export class GoogleStorageBucket extends TerraformResource {
  ...
  private _cors?: GoogleStorageBucketCors[];
  public get cors() {
    return this._cors;
  }
  public set cors(value: GoogleStorageBucketCors[] | undefined) {
    this._cors = value;
  }

  // encryption - computed: false, optional: true, required: false
  private _encryption?: GoogleStorageBucketEncryption[];
  public get encryption() {
    return this._encryption;
  }
  public set encryption(value: GoogleStorageBucketEncryption[] | undefined) {
    this._encryption = value;
  }

  // lifecycle_rule - computed: false, optional: true, required: false
  private _lifecycleRule?: GoogleStorageBucketLifecycleRule[];
  public get lifecycleRule() {
    return this._lifecycleRule;
  }
  public set lifecycleRule(value: GoogleStorageBucketLifecycleRule[] | undefined) {
    this._lifecycleRule = value;
  }

  // logging - computed: false, optional: true, required: false
  private _logging?: GoogleStorageBucketLogging[];
  public get logging() {
    return this._logging;
  }
  public set logging(value: GoogleStorageBucketLogging[] | undefined) {
    this._logging = value;
  }

  // retention_policy - computed: false, optional: true, required: false
  private _retentionPolicy?: GoogleStorageBucketRetentionPolicy[];
  public get retentionPolicy() {
    return this._retentionPolicy;
  }
  public set retentionPolicy(value: GoogleStorageBucketRetentionPolicy[] | undefined) {
    this._retentionPolicy = value;
  }

  // versioning - computed: false, optional: true, required: false
  private _versioning?: GoogleStorageBucketVersioning[];
  public get versioning() {
    return this._versioning;
  }
  public set versioning(value: GoogleStorageBucketVersioning[] | undefined) {
    this._versioning = value;
  }

  // website - computed: false, optional: true, required: false
  private _website?: GoogleStorageBucketWebsite[];
  public get website() {
    return this._website;
  }
  public set website(value: GoogleStorageBucketWebsite[] | undefined) {
    this._website = value;
  }
