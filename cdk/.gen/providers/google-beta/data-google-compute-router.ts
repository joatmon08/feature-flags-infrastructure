// https://www.terraform.io/docs/providers/google-beta/r/data_google_compute_router_a.html
...
export interface DataGoogleComputeRouterAConfig extends TerraformMetaArguments {
...
export class DataGoogleComputeRouterBgpAdvertisedIpRangesA extends ComplexComputedList {
...
export class DataGoogleComputeRouterBgpA extends ComplexComputedList {
...
export class DataGoogleComputeRouterA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleComputeRouterAConfig) {
    super(scope, id, {
  ...
  public bgp(index: string) {
    return new DataGoogleComputeRouterBgpA(this, 'bgp', index);
  }
