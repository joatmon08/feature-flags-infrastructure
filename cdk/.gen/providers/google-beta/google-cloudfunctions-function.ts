// https://www.terraform.io/docs/providers/google-beta/r/google_cloudfunctions_function.html
...
export interface GoogleCloudfunctionsFunctionConfig extends TerraformMetaArguments {
...
export class GoogleCloudfunctionsFunction extends TerraformResource {
  ...
  private _eventTrigger?: GoogleCloudfunctionsFunctionEventTrigger[];
  public get eventTrigger() {
    return this._eventTrigger;
  }
  public set eventTrigger(value: GoogleCloudfunctionsFunctionEventTrigger[] | undefined) {
    this._eventTrigger = value;
  }

  // source_repository - computed: false, optional: true, required: false
  private _sourceRepository?: GoogleCloudfunctionsFunctionSourceRepository[];
  public get sourceRepository() {
    return this._sourceRepository;
  }
  public set sourceRepository(value: GoogleCloudfunctionsFunctionSourceRepository[] | undefined) {
    this._sourceRepository = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleCloudfunctionsFunctionTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleCloudfunctionsFunctionTimeouts | undefined) {
