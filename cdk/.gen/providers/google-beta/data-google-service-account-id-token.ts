// https://www.terraform.io/docs/providers/google-beta/r/data_google_service_account_id_token_a.html
...
export interface DataGoogleServiceAccountIdTokenAConfig extends TerraformMetaArguments {
...
export class DataGoogleServiceAccountIdTokenA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleServiceAccountIdTokenAConfig) {
    super(scope, id, {
