// https://www.terraform.io/docs/providers/google-beta/r/data_google_folder_a.html
...
export interface DataGoogleFolderAConfig extends TerraformMetaArguments {
...
export class DataGoogleFolderA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleFolderAConfig) {
    super(scope, id, {
