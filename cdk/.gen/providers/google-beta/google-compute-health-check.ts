// https://www.terraform.io/docs/providers/google-beta/r/google_compute_health_check.html
...
export interface GoogleComputeHealthCheckConfig extends TerraformMetaArguments {
...
export class GoogleComputeHealthCheck extends TerraformResource {
  ...
  private _http2HealthCheck?: GoogleComputeHealthCheckHttp2HealthCheck[];
  public get http2HealthCheck() {
    return this._http2HealthCheck;
  }
  public set http2HealthCheck(value: GoogleComputeHealthCheckHttp2HealthCheck[] | undefined) {
    this._http2HealthCheck = value;
  }

  // http_health_check - computed: false, optional: true, required: false
  private _httpHealthCheck?: GoogleComputeHealthCheckHttpHealthCheck[];
  public get httpHealthCheck() {
    return this._httpHealthCheck;
  }
  public set httpHealthCheck(value: GoogleComputeHealthCheckHttpHealthCheck[] | undefined) {
    this._httpHealthCheck = value;
  }

  // https_health_check - computed: false, optional: true, required: false
  private _httpsHealthCheck?: GoogleComputeHealthCheckHttpsHealthCheck[];
  public get httpsHealthCheck() {
    return this._httpsHealthCheck;
  }
  public set httpsHealthCheck(value: GoogleComputeHealthCheckHttpsHealthCheck[] | undefined) {
    this._httpsHealthCheck = value;
  }

  // log_config - computed: false, optional: true, required: false
  private _logConfig?: GoogleComputeHealthCheckLogConfig[];
  public get logConfig() {
    return this._logConfig;
  }
  public set logConfig(value: GoogleComputeHealthCheckLogConfig[] | undefined) {
    this._logConfig = value;
  }

  // ssl_health_check - computed: false, optional: true, required: false
  private _sslHealthCheck?: GoogleComputeHealthCheckSslHealthCheck[];
  public get sslHealthCheck() {
    return this._sslHealthCheck;
  }
  public set sslHealthCheck(value: GoogleComputeHealthCheckSslHealthCheck[] | undefined) {
    this._sslHealthCheck = value;
  }

  // tcp_health_check - computed: false, optional: true, required: false
  private _tcpHealthCheck?: GoogleComputeHealthCheckTcpHealthCheck[];
  public get tcpHealthCheck() {
    return this._tcpHealthCheck;
  }
  public set tcpHealthCheck(value: GoogleComputeHealthCheckTcpHealthCheck[] | undefined) {
    this._tcpHealthCheck = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleComputeHealthCheckTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleComputeHealthCheckTimeouts | undefined) {
