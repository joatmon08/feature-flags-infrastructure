// https://www.terraform.io/docs/providers/google-beta/r/google_compute_interconnect_attachment.html
...
export interface GoogleComputeInterconnectAttachmentConfig extends TerraformMetaArguments {
...
export class GoogleComputeInterconnectAttachmentPrivateInterconnectInfo extends ComplexComputedList {
...
export class GoogleComputeInterconnectAttachment extends TerraformResource {
  ...
  public privateInterconnectInfo(index: string) {
    return new GoogleComputeInterconnectAttachmentPrivateInterconnectInfo(this, 'private_interconnect_info', index);
  }
  ...
  private _timeouts?: GoogleComputeInterconnectAttachmentTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleComputeInterconnectAttachmentTimeouts | undefined) {
