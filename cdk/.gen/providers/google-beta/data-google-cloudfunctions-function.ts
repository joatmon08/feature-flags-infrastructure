// https://www.terraform.io/docs/providers/google-beta/r/data_google_cloudfunctions_function_a.html
...
export interface DataGoogleCloudfunctionsFunctionAConfig extends TerraformMetaArguments {
...
export class DataGoogleCloudfunctionsFunctionEventTriggerFailurePolicyA extends ComplexComputedList {
...
export class DataGoogleCloudfunctionsFunctionEventTriggerA extends ComplexComputedList {
...
export class DataGoogleCloudfunctionsFunctionSourceRepositoryA extends ComplexComputedList {
...
export class DataGoogleCloudfunctionsFunctionA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleCloudfunctionsFunctionAConfig) {
    super(scope, id, {
  ...
  public eventTrigger(index: string) {
    return new DataGoogleCloudfunctionsFunctionEventTriggerA(this, 'event_trigger', index);
  }
  ...
  public sourceRepository(index: string) {
    return new DataGoogleCloudfunctionsFunctionSourceRepositoryA(this, 'source_repository', index);
  }
