// https://www.terraform.io/docs/providers/google-beta/r/google_network_management_connectivity_test.html
...
export interface GoogleNetworkManagementConnectivityTestConfig extends TerraformMetaArguments {
...
export class GoogleNetworkManagementConnectivityTest extends TerraformResource {
  ...
  private _destination: GoogleNetworkManagementConnectivityTestDestination[];
  public get destination() {
    return this._destination;
  }
  public set destination(value: GoogleNetworkManagementConnectivityTestDestination[]) {
    this._destination = value;
  }

  // source - computed: false, optional: false, required: true
  private _source: GoogleNetworkManagementConnectivityTestSource[];
  public get source() {
    return this._source;
  }
  public set source(value: GoogleNetworkManagementConnectivityTestSource[]) {
    this._source = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleNetworkManagementConnectivityTestTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleNetworkManagementConnectivityTestTimeouts | undefined) {
