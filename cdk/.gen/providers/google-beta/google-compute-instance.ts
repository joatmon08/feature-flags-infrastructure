// https://www.terraform.io/docs/providers/google-beta/r/google_compute_instance.html
...
export interface GoogleComputeInstanceConfig extends TerraformMetaArguments {
  ...
  readonly guestAccelerator?: GoogleComputeInstanceGuestAccelerator[];
  ...
  /** attached_disk block */
  readonly attachedDisk?: GoogleComputeInstanceAttachedDisk[];
  /** boot_disk block */
  readonly bootDisk: GoogleComputeInstanceBootDisk[];
  /** network_interface block */
  readonly networkInterface: GoogleComputeInstanceNetworkInterface[];
  /** scheduling block */
  readonly scheduling?: GoogleComputeInstanceScheduling[];
  /** scratch_disk block */
  readonly scratchDisk?: GoogleComputeInstanceScratchDisk[];
...
export interface GoogleComputeInstanceNetworkInterface {
  ...
  /** access_config block */
  readonly accessConfig?: GoogleComputeInstanceNetworkInterfaceAccessConfig[];
  /** alias_ip_range block */
  readonly aliasIpRange?: GoogleComputeInstanceNetworkInterfaceAliasIpRange[];
}
...
export interface GoogleComputeInstanceScheduling {
  ...
  readonly nodeAffinities?: GoogleComputeInstanceSchedulingNodeAffinities[];
}
...
export class GoogleComputeInstance extends TerraformResource {
  ...
  private _guestAccelerator?: GoogleComputeInstanceGuestAccelerator[]
  public get guestAccelerator(): GoogleComputeInstanceGuestAccelerator[] | undefined {
    return this._guestAccelerator; // Getting the computed value is not yet implemented
  }
  public set guestAccelerator(value: GoogleComputeInstanceGuestAccelerator[] | undefined) {
  ...
  private _attachedDisk?: GoogleComputeInstanceAttachedDisk[];
  public get attachedDisk() {
    return this._attachedDisk;
  }
  public set attachedDisk(value: GoogleComputeInstanceAttachedDisk[] | undefined) {
    this._attachedDisk = value;
  }

  // boot_disk - computed: false, optional: false, required: true
  private _bootDisk: GoogleComputeInstanceBootDisk[];
  public get bootDisk() {
    return this._bootDisk;
  }
  public set bootDisk(value: GoogleComputeInstanceBootDisk[]) {
    this._bootDisk = value;
  }

  // network_interface - computed: false, optional: false, required: true
  private _networkInterface: GoogleComputeInstanceNetworkInterface[];
  public get networkInterface() {
    return this._networkInterface;
  }
  public set networkInterface(value: GoogleComputeInstanceNetworkInterface[]) {
    this._networkInterface = value;
  }

  // scheduling - computed: false, optional: true, required: false
  private _scheduling?: GoogleComputeInstanceScheduling[];
  public get scheduling() {
    return this._scheduling;
  }
  public set scheduling(value: GoogleComputeInstanceScheduling[] | undefined) {
    this._scheduling = value;
  }

  // scratch_disk - computed: false, optional: true, required: false
  private _scratchDisk?: GoogleComputeInstanceScratchDisk[];
  public get scratchDisk() {
    return this._scratchDisk;
  }
  public set scratchDisk(value: GoogleComputeInstanceScratchDisk[] | undefined) {
    this._scratchDisk = value;
  }

  // service_account - computed: false, optional: true, required: false
  private _serviceAccount?: GoogleComputeInstanceServiceAccount[];
  public get serviceAccount() {
    return this._serviceAccount;
  }
  public set serviceAccount(value: GoogleComputeInstanceServiceAccount[] | undefined) {
    this._serviceAccount = value;
  }

  // shielded_instance_config - computed: false, optional: true, required: false
  private _shieldedInstanceConfig?: GoogleComputeInstanceShieldedInstanceConfig[];
  public get shieldedInstanceConfig() {
    return this._shieldedInstanceConfig;
  }
  public set shieldedInstanceConfig(value: GoogleComputeInstanceShieldedInstanceConfig[] | undefined) {
    this._shieldedInstanceConfig = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleComputeInstanceTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleComputeInstanceTimeouts | undefined) {
