// https://www.terraform.io/docs/providers/google-beta/r/google_app_engine_domain_mapping.html
...
export interface GoogleAppEngineDomainMappingConfig extends TerraformMetaArguments {
...
export class GoogleAppEngineDomainMappingResourceRecords extends ComplexComputedList {
...
export class GoogleAppEngineDomainMapping extends TerraformResource {
  ...
  public resourceRecords(index: string) {
    return new GoogleAppEngineDomainMappingResourceRecords(this, 'resource_records', index);
  }

  // ssl_settings - computed: false, optional: true, required: false
  private _sslSettings?: GoogleAppEngineDomainMappingSslSettings[];
  public get sslSettings() {
    return this._sslSettings;
  }
  public set sslSettings(value: GoogleAppEngineDomainMappingSslSettings[] | undefined) {
    this._sslSettings = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleAppEngineDomainMappingTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleAppEngineDomainMappingTimeouts | undefined) {
