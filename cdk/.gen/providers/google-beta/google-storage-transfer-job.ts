// https://www.terraform.io/docs/providers/google-beta/r/google_storage_transfer_job.html
...
export interface GoogleStorageTransferJobConfig extends TerraformMetaArguments {
...
export class GoogleStorageTransferJob extends TerraformResource {
  ...
  private _schedule: GoogleStorageTransferJobSchedule[];
  public get schedule() {
    return this._schedule;
  }
  public set schedule(value: GoogleStorageTransferJobSchedule[]) {
    this._schedule = value;
  }

  // transfer_spec - computed: false, optional: false, required: true
  private _transferSpec: GoogleStorageTransferJobTransferSpec[];
  public get transferSpec() {
    return this._transferSpec;
  }
  public set transferSpec(value: GoogleStorageTransferJobTransferSpec[]) {
