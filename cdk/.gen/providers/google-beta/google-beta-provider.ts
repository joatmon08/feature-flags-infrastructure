// https://www.terraform.io/docs/providers/google-beta/r/google_beta_provider.html
...
export class GoogleBetaProvider extends TerraformProvider {
  ...
  public constructor(scope: Construct, id: string, config: GoogleBetaProviderConfig = {}) {
    super(scope, id, {
      ...
      terraformGeneratorMetadata: {
        ...
        providerVersionConstraint: '~> 3.34'
      },
    });
  ...
  public synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      artifact_registry_custom_endpoint: this._artifactRegistryCustomEndpoint,
      big_query_custom_endpoint: this._bigQueryCustomEndpoint,
      bigquery_connection_custom_endpoint: this._bigqueryConnectionCustomEndpoint,
      bigquery_data_transfer_custom_endpoint: this._bigqueryDataTransferCustomEndpoint,
      bigquery_reservation_custom_endpoint: this._bigqueryReservationCustomEndpoint,
      bigtable_custom_endpoint: this._bigtableCustomEndpoint,
      billing_custom_endpoint: this._billingCustomEndpoint,
      ...
      data_fusion_custom_endpoint: this._dataFusionCustomEndpoint,
      ...
      firebase_custom_endpoint: this._firebaseCustomEndpoint,
      ...
      memcache_custom_endpoint: this._memcacheCustomEndpoint,
      ...
      notebooks_custom_endpoint: this._notebooksCustomEndpoint,
      ...
      security_scanner_custom_endpoint: this._securityScannerCustomEndpoint,
      service_directory_custom_endpoint: this._serviceDirectoryCustomEndpoint,
