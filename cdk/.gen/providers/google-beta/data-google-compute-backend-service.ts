// https://www.terraform.io/docs/providers/google-beta/r/data_google_compute_backend_service_a.html
...
export interface DataGoogleComputeBackendServiceAConfig extends TerraformMetaArguments {
...
export class DataGoogleComputeBackendServiceBackendA extends ComplexComputedList {
...
export class DataGoogleComputeBackendServiceCdnPolicyCacheKeyPolicyA extends ComplexComputedList {
...
export class DataGoogleComputeBackendServiceCdnPolicyA extends ComplexComputedList {
...
export class DataGoogleComputeBackendServiceCircuitBreakersConnectTimeout extends ComplexComputedList {
...
export class DataGoogleComputeBackendServiceCircuitBreakersA extends ComplexComputedList {
...
export class DataGoogleComputeBackendServiceConsistentHashHttpCookieTtlA extends ComplexComputedList {
...
export class DataGoogleComputeBackendServiceConsistentHashHttpCookieA extends ComplexComputedList {
...
export class DataGoogleComputeBackendServiceConsistentHashA extends ComplexComputedList {
...
export class DataGoogleComputeBackendServiceIapA extends ComplexComputedList {
...
export class DataGoogleComputeBackendServiceLogConfigA extends ComplexComputedList {
...
export class DataGoogleComputeBackendServiceOutlierDetectionBaseEjectionTimeA extends ComplexComputedList {
...
export class DataGoogleComputeBackendServiceOutlierDetectionIntervalA extends ComplexComputedList {
...
export class DataGoogleComputeBackendServiceOutlierDetectionA extends ComplexComputedList {
...
export class DataGoogleComputeBackendServiceA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleComputeBackendServiceAConfig) {
    super(scope, id, {
  ...
  public backend(index: string) {
    return new DataGoogleComputeBackendServiceBackendA(this, 'backend', index);
  }

  // cdn_policy - computed: true, optional: false, required: true
  public cdnPolicy(index: string) {
    return new DataGoogleComputeBackendServiceCdnPolicyA(this, 'cdn_policy', index);
  }

  // circuit_breakers - computed: true, optional: false, required: true
  public circuitBreakers(index: string) {
    return new DataGoogleComputeBackendServiceCircuitBreakersA(this, 'circuit_breakers', index);
  }
  ...
  public consistentHash(index: string) {
    return new DataGoogleComputeBackendServiceConsistentHashA(this, 'consistent_hash', index);
  }
  ...
  public iap(index: string) {
    return new DataGoogleComputeBackendServiceIapA(this, 'iap', index);
  }
  ...
  public logConfig(index: string) {
    return new DataGoogleComputeBackendServiceLogConfigA(this, 'log_config', index);
  }
  ...
  public outlierDetection(index: string) {
    return new DataGoogleComputeBackendServiceOutlierDetectionA(this, 'outlier_detection', index);
  }
