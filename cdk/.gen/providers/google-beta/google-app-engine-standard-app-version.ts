// https://www.terraform.io/docs/providers/google-beta/r/google_app_engine_standard_app_version.html
...
export interface GoogleAppEngineStandardAppVersionConfig extends TerraformMetaArguments {
...
Please see the app.yaml reference for valid values at https://cloud.google.com/appengine/docs/standard//config/appref */
  ...
  /** handlers block */
  readonly handlers?: GoogleAppEngineStandardAppVersionHandlers[];
  /** libraries block */
  readonly libraries?: GoogleAppEngineStandardAppVersionLibraries[];
...
export interface GoogleAppEngineStandardAppVersionDeployment {
  /** files block */
  readonly files?: GoogleAppEngineStandardAppVersionDeploymentFiles[];
  /** zip block */
...
export class GoogleAppEngineStandardAppVersion extends TerraformResource {
  ...
  private _automaticScaling?: GoogleAppEngineStandardAppVersionAutomaticScaling[];
  public get automaticScaling() {
    return this._automaticScaling;
  }
  public set automaticScaling(value: GoogleAppEngineStandardAppVersionAutomaticScaling[] | undefined) {
    this._automaticScaling = value;
  }

  // basic_scaling - computed: false, optional: true, required: false
  private _basicScaling?: GoogleAppEngineStandardAppVersionBasicScaling[];
  public get basicScaling() {
    return this._basicScaling;
  }
  public set basicScaling(value: GoogleAppEngineStandardAppVersionBasicScaling[] | undefined) {
    this._basicScaling = value;
  }

  // deployment - computed: false, optional: false, required: true
  private _deployment: GoogleAppEngineStandardAppVersionDeployment[];
  public get deployment() {
    return this._deployment;
  }
  public set deployment(value: GoogleAppEngineStandardAppVersionDeployment[]) {
    this._deployment = value;
  }

  // entrypoint - computed: false, optional: true, required: false
  private _entrypoint?: GoogleAppEngineStandardAppVersionEntrypoint[];
  public get entrypoint() {
    return this._entrypoint;
  }
  public set entrypoint(value: GoogleAppEngineStandardAppVersionEntrypoint[] | undefined) {
    this._entrypoint = value;
  }

  // handlers - computed: false, optional: true, required: false
  private _handlers?: GoogleAppEngineStandardAppVersionHandlers[];
  public get handlers() {
    return this._handlers;
  }
  public set handlers(value: GoogleAppEngineStandardAppVersionHandlers[] | undefined) {
    this._handlers = value;
  }

  // libraries - computed: false, optional: true, required: false
  private _libraries?: GoogleAppEngineStandardAppVersionLibraries[];
  public get libraries() {
    return this._libraries;
  }
  public set libraries(value: GoogleAppEngineStandardAppVersionLibraries[] | undefined) {
    this._libraries = value;
  }

  // manual_scaling - computed: false, optional: true, required: false
  private _manualScaling?: GoogleAppEngineStandardAppVersionManualScaling[];
  public get manualScaling() {
    return this._manualScaling;
  }
  public set manualScaling(value: GoogleAppEngineStandardAppVersionManualScaling[] | undefined) {
    this._manualScaling = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleAppEngineStandardAppVersionTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleAppEngineStandardAppVersionTimeouts | undefined) {
