// https://www.terraform.io/docs/providers/google-beta/r/data_google_organization_a.html
...
export interface DataGoogleOrganizationAConfig extends TerraformMetaArguments {
...
export class DataGoogleOrganizationA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleOrganizationAConfig = {}) {
    super(scope, id, {
