// https://www.terraform.io/docs/providers/google-beta/r/google_container_analysis_note.html
...
export interface GoogleContainerAnalysisNoteConfig extends TerraformMetaArguments {
  ...
  /** related_url block */
  readonly relatedUrl?: GoogleContainerAnalysisNoteRelatedUrl[];
  /** timeouts block */
...
export class GoogleContainerAnalysisNote extends TerraformResource {
  ...
  private _attestationAuthority: GoogleContainerAnalysisNoteAttestationAuthority[];
  public get attestationAuthority() {
    return this._attestationAuthority;
  }
  public set attestationAuthority(value: GoogleContainerAnalysisNoteAttestationAuthority[]) {
    this._attestationAuthority = value;
  }

  // related_url - computed: false, optional: true, required: false
  private _relatedUrl?: GoogleContainerAnalysisNoteRelatedUrl[];
  public get relatedUrl() {
    return this._relatedUrl;
  }
  public set relatedUrl(value: GoogleContainerAnalysisNoteRelatedUrl[] | undefined) {
    this._relatedUrl = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleContainerAnalysisNoteTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleContainerAnalysisNoteTimeouts | undefined) {
