// https://www.terraform.io/docs/providers/google-beta/r/google_logging_organization_sink.html
...
export interface GoogleLoggingOrganizationSinkConfig extends TerraformMetaArguments {
...
export class GoogleLoggingOrganizationSink extends TerraformResource {
  ...
  private _bigqueryOptions?: GoogleLoggingOrganizationSinkBigqueryOptions[];
  public get bigqueryOptions() {
    return this._bigqueryOptions;
  }
  public set bigqueryOptions(value: GoogleLoggingOrganizationSinkBigqueryOptions[] | undefined) {
