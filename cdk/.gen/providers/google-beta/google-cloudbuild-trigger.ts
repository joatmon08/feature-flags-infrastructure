// https://www.terraform.io/docs/providers/google-beta/r/google_cloudbuild_trigger.html
...
export interface GoogleCloudbuildTriggerConfig extends TerraformMetaArguments {
...
have completed successfully. */
  ...
  /** volumes block */
  readonly volumes?: GoogleCloudbuildTriggerBuildStepVolumes[];
}
...
Default time is ten minutes (600s). */
  readonly timeout?: string;
  /** step block */
  readonly step: GoogleCloudbuildTriggerBuildStep[];
}
...
export class GoogleCloudbuildTrigger extends TerraformResource {
  ...
  private _build?: GoogleCloudbuildTriggerBuild[];
  public get buildAttribute() {
    return this._build;
  }
  public set buildAttribute(value: GoogleCloudbuildTriggerBuild[] | undefined) {
    this._build = value;
  }

  // github - computed: false, optional: true, required: false
  private _github?: GoogleCloudbuildTriggerGithub[];
  public get github() {
    return this._github;
  }
  public set github(value: GoogleCloudbuildTriggerGithub[] | undefined) {
    this._github = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleCloudbuildTriggerTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleCloudbuildTriggerTimeouts | undefined) {
    this._timeouts = value;
  }

  // trigger_template - computed: false, optional: true, required: false
  private _triggerTemplate?: GoogleCloudbuildTriggerTriggerTemplate[];
  public get triggerTemplate() {
    return this._triggerTemplate;
  }
  public set triggerTemplate(value: GoogleCloudbuildTriggerTriggerTemplate[] | undefined) {
