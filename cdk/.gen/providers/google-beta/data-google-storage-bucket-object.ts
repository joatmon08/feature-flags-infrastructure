// https://www.terraform.io/docs/providers/google-beta/r/data_google_storage_bucket_object_a.html
...
export interface DataGoogleStorageBucketObjectAConfig extends TerraformMetaArguments {
...
export class DataGoogleStorageBucketObjectA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleStorageBucketObjectAConfig = {}) {
    super(scope, id, {
