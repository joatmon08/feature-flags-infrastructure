// https://www.terraform.io/docs/providers/google-beta/r/google_cloud_tasks_queue.html
...
export interface GoogleCloudTasksQueueConfig extends TerraformMetaArguments {
...
export class GoogleCloudTasksQueue extends TerraformResource {
  ...
  private _appEngineRoutingOverride?: GoogleCloudTasksQueueAppEngineRoutingOverride[];
  public get appEngineRoutingOverride() {
    return this._appEngineRoutingOverride;
  }
  public set appEngineRoutingOverride(value: GoogleCloudTasksQueueAppEngineRoutingOverride[] | undefined) {
    this._appEngineRoutingOverride = value;
  }

  // rate_limits - computed: false, optional: true, required: false
  private _rateLimits?: GoogleCloudTasksQueueRateLimits[];
  public get rateLimits() {
    return this._rateLimits;
  }
  public set rateLimits(value: GoogleCloudTasksQueueRateLimits[] | undefined) {
    this._rateLimits = value;
  }

  // retry_config - computed: false, optional: true, required: false
  private _retryConfig?: GoogleCloudTasksQueueRetryConfig[];
  public get retryConfig() {
    return this._retryConfig;
  }
  public set retryConfig(value: GoogleCloudTasksQueueRetryConfig[] | undefined) {
    this._retryConfig = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleCloudTasksQueueTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleCloudTasksQueueTimeouts | undefined) {
