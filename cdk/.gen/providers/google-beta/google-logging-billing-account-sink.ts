// https://www.terraform.io/docs/providers/google-beta/r/google_logging_billing_account_sink.html
...
export interface GoogleLoggingBillingAccountSinkConfig extends TerraformMetaArguments {
...
export class GoogleLoggingBillingAccountSink extends TerraformResource {
  ...
  private _bigqueryOptions?: GoogleLoggingBillingAccountSinkBigqueryOptions[];
  public get bigqueryOptions() {
    return this._bigqueryOptions;
  }
  public set bigqueryOptions(value: GoogleLoggingBillingAccountSinkBigqueryOptions[] | undefined) {
