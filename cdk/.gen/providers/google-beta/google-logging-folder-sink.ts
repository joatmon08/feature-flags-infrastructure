// https://www.terraform.io/docs/providers/google-beta/r/google_logging_folder_sink.html
...
export interface GoogleLoggingFolderSinkConfig extends TerraformMetaArguments {
...
export class GoogleLoggingFolderSink extends TerraformResource {
  ...
  private _bigqueryOptions?: GoogleLoggingFolderSinkBigqueryOptions[];
  public get bigqueryOptions() {
    return this._bigqueryOptions;
  }
  public set bigqueryOptions(value: GoogleLoggingFolderSinkBigqueryOptions[] | undefined) {
