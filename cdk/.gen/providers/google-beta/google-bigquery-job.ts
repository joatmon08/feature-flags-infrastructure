// https://www.terraform.io/docs/providers/google-beta/r/google_bigquery_job.html
...
export interface GoogleBigqueryJobConfig extends TerraformMetaArguments {
...
Creation, truncation and append actions occur as one atomic update upon job completion. Default value: "WRITE_EMPTY" Possible values: ["WRITE_TRUNCATE", "WRITE_APPEND", "WRITE_EMPTY"] */
  ...
  /** source_tables block */
  readonly sourceTables: GoogleBigqueryJobCopySourceTables[];
}
...
Creation, truncation and append actions occur as one atomic update upon job completion. Default value: "WRITE_EMPTY" Possible values: ["WRITE_TRUNCATE", "WRITE_APPEND", "WRITE_EMPTY"] */
  ...
  readonly userDefinedFunctionResources?: GoogleBigqueryJobQueryUserDefinedFunctionResources[];
}
...
export class GoogleBigqueryJob extends TerraformResource {
  ...
  private _copy?: GoogleBigqueryJobCopy[];
  public get copy() {
    return this._copy;
  }
  public set copy(value: GoogleBigqueryJobCopy[] | undefined) {
    this._copy = value;
  }

  // extract - computed: false, optional: true, required: false
  private _extract?: GoogleBigqueryJobExtract[];
  public get extract() {
    return this._extract;
  }
  public set extract(value: GoogleBigqueryJobExtract[] | undefined) {
    this._extract = value;
  }

  // load - computed: false, optional: true, required: false
  private _load?: GoogleBigqueryJobLoad[];
  public get load() {
    return this._load;
  }
  public set load(value: GoogleBigqueryJobLoad[] | undefined) {
    this._load = value;
  }

  // query - computed: false, optional: true, required: false
  private _query?: GoogleBigqueryJobQuery[];
  public get query() {
    return this._query;
  }
  public set query(value: GoogleBigqueryJobQuery[] | undefined) {
    this._query = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleBigqueryJobTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleBigqueryJobTimeouts | undefined) {
