// https://www.terraform.io/docs/providers/google-beta/r/data_google_compute_subnetwork_a.html
...
export interface DataGoogleComputeSubnetworkAConfig extends TerraformMetaArguments {
  readonly name?: string;
  readonly project?: string;
  readonly region?: string;
  readonly selfLink?: string;
}
export class DataGoogleComputeSubnetworkSecondaryIpRangeA extends ComplexComputedList {
...
export class DataGoogleComputeSubnetworkA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleComputeSubnetworkAConfig = {}) {
    super(scope, id, {
  ...
  public secondaryIpRange(index: string) {
    return new DataGoogleComputeSubnetworkSecondaryIpRangeA(this, 'secondary_ip_range', index);
  }
