// https://www.terraform.io/docs/providers/google-beta/r/google_binary_authorization_policy.html
...
export interface GoogleBinaryAuthorizationPolicyConfig extends TerraformMetaArguments {
...
policy will be subject to the project admission policy. Possible values: ["ENABLE", "DISABLE"] */
  ...
  readonly admissionWhitelistPatterns?: GoogleBinaryAuthorizationPolicyAdmissionWhitelistPatterns[];
  /** cluster_admission_rules block */
  readonly clusterAdmissionRules?: GoogleBinaryAuthorizationPolicyClusterAdmissionRules[];
...
export class GoogleBinaryAuthorizationPolicy extends TerraformResource {
  ...
  private _admissionWhitelistPatterns?: GoogleBinaryAuthorizationPolicyAdmissionWhitelistPatterns[];
  public get admissionWhitelistPatterns() {
    return this._admissionWhitelistPatterns;
  }
  public set admissionWhitelistPatterns(value: GoogleBinaryAuthorizationPolicyAdmissionWhitelistPatterns[] | undefined) {
    this._admissionWhitelistPatterns = value;
  }

  // cluster_admission_rules - computed: false, optional: true, required: false
  private _clusterAdmissionRules?: GoogleBinaryAuthorizationPolicyClusterAdmissionRules[];
  public get clusterAdmissionRules() {
    return this._clusterAdmissionRules;
  }
  public set clusterAdmissionRules(value: GoogleBinaryAuthorizationPolicyClusterAdmissionRules[] | undefined) {
    this._clusterAdmissionRules = value;
  }

  // default_admission_rule - computed: false, optional: false, required: true
  private _defaultAdmissionRule: GoogleBinaryAuthorizationPolicyDefaultAdmissionRule[];
  public get defaultAdmissionRule() {
    return this._defaultAdmissionRule;
  }
  public set defaultAdmissionRule(value: GoogleBinaryAuthorizationPolicyDefaultAdmissionRule[]) {
    this._defaultAdmissionRule = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleBinaryAuthorizationPolicyTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleBinaryAuthorizationPolicyTimeouts | undefined) {
