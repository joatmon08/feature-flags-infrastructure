// https://www.terraform.io/docs/providers/google-beta/r/data_google_netblock_ip_ranges_a.html
...
export interface DataGoogleNetblockIpRangesAConfig extends TerraformMetaArguments {
  readonly rangeType?: string;
}

// Resource

export class DataGoogleNetblockIpRangesA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleNetblockIpRangesAConfig = {}) {
    super(scope, id, {
