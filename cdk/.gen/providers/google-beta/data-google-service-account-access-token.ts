// https://www.terraform.io/docs/providers/google-beta/r/data_google_service_account_access_token_a.html
...
export interface DataGoogleServiceAccountAccessTokenAConfig extends TerraformMetaArguments {
...
export class DataGoogleServiceAccountAccessTokenA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleServiceAccountAccessTokenAConfig) {
    super(scope, id, {
