// https://www.terraform.io/docs/providers/google-beta/r/google_compute_region_health_check.html
...
export interface GoogleComputeRegionHealthCheckConfig extends TerraformMetaArguments {
...
export class GoogleComputeRegionHealthCheck extends TerraformResource {
  ...
  private _http2HealthCheck?: GoogleComputeRegionHealthCheckHttp2HealthCheck[];
  public get http2HealthCheck() {
    return this._http2HealthCheck;
  }
  public set http2HealthCheck(value: GoogleComputeRegionHealthCheckHttp2HealthCheck[] | undefined) {
    this._http2HealthCheck = value;
  }

  // http_health_check - computed: false, optional: true, required: false
  private _httpHealthCheck?: GoogleComputeRegionHealthCheckHttpHealthCheck[];
  public get httpHealthCheck() {
    return this._httpHealthCheck;
  }
  public set httpHealthCheck(value: GoogleComputeRegionHealthCheckHttpHealthCheck[] | undefined) {
    this._httpHealthCheck = value;
  }

  // https_health_check - computed: false, optional: true, required: false
  private _httpsHealthCheck?: GoogleComputeRegionHealthCheckHttpsHealthCheck[];
  public get httpsHealthCheck() {
    return this._httpsHealthCheck;
  }
  public set httpsHealthCheck(value: GoogleComputeRegionHealthCheckHttpsHealthCheck[] | undefined) {
    this._httpsHealthCheck = value;
  }

  // log_config - computed: false, optional: true, required: false
  private _logConfig?: GoogleComputeRegionHealthCheckLogConfig[];
  public get logConfig() {
    return this._logConfig;
  }
  public set logConfig(value: GoogleComputeRegionHealthCheckLogConfig[] | undefined) {
    this._logConfig = value;
  }

  // ssl_health_check - computed: false, optional: true, required: false
  private _sslHealthCheck?: GoogleComputeRegionHealthCheckSslHealthCheck[];
  public get sslHealthCheck() {
    return this._sslHealthCheck;
  }
  public set sslHealthCheck(value: GoogleComputeRegionHealthCheckSslHealthCheck[] | undefined) {
    this._sslHealthCheck = value;
  }

  // tcp_health_check - computed: false, optional: true, required: false
  private _tcpHealthCheck?: GoogleComputeRegionHealthCheckTcpHealthCheck[];
  public get tcpHealthCheck() {
    return this._tcpHealthCheck;
  }
  public set tcpHealthCheck(value: GoogleComputeRegionHealthCheckTcpHealthCheck[] | undefined) {
    this._tcpHealthCheck = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleComputeRegionHealthCheckTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleComputeRegionHealthCheckTimeouts | undefined) {
