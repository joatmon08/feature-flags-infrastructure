// https://www.terraform.io/docs/providers/google-beta/r/google_logging_metric.html
...
export interface GoogleLoggingMetricConfig extends TerraformMetaArguments {
...
For counter metrics, set this to INT64. Possible values: ["BOOL", "INT64", "DOUBLE", "STRING", "DISTRIBUTION", "MONEY"] */
  readonly valueType: string;
  /** labels block */
  readonly labels?: GoogleLoggingMetricMetricDescriptorLabels[];
}
...
export class GoogleLoggingMetric extends TerraformResource {
  ...
  private _bucketOptions?: GoogleLoggingMetricBucketOptions[];
  public get bucketOptions() {
    return this._bucketOptions;
  }
  public set bucketOptions(value: GoogleLoggingMetricBucketOptions[] | undefined) {
    this._bucketOptions = value;
  }

  // metric_descriptor - computed: false, optional: false, required: true
  private _metricDescriptor: GoogleLoggingMetricMetricDescriptor[];
  public get metricDescriptor() {
    return this._metricDescriptor;
  }
  public set metricDescriptor(value: GoogleLoggingMetricMetricDescriptor[]) {
    this._metricDescriptor = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleLoggingMetricTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleLoggingMetricTimeouts | undefined) {
