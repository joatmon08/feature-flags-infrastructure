// https://www.terraform.io/docs/providers/google-beta/r/google_compute_router_nat.html
...
export interface GoogleComputeRouterNatConfig extends TerraformMetaArguments {
...
Defaults to 30s if not set. */
  ...
  /** subnetwork block */
  readonly subnetwork?: GoogleComputeRouterNatSubnetwork[];
  /** timeouts block */
...
export class GoogleComputeRouterNat extends TerraformResource {
  ...
  private _logConfig?: GoogleComputeRouterNatLogConfig[];
  public get logConfig() {
    return this._logConfig;
  }
  public set logConfig(value: GoogleComputeRouterNatLogConfig[] | undefined) {
    this._logConfig = value;
  }

  // subnetwork - computed: false, optional: true, required: false
  private _subnetwork?: GoogleComputeRouterNatSubnetwork[];
  public get subnetwork() {
    return this._subnetwork;
  }
  public set subnetwork(value: GoogleComputeRouterNatSubnetwork[] | undefined) {
    this._subnetwork = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleComputeRouterNatTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleComputeRouterNatTimeouts | undefined) {
