// https://www.terraform.io/docs/providers/google-beta/r/google_compute_resource_policy.html
...
export interface GoogleComputeResourcePolicyConfig extends TerraformMetaArguments {
...
export interface GoogleComputeResourcePolicySnapshotSchedulePolicyScheduleWeeklySchedule {
  /** day_of_weeks block */
  readonly dayOfWeeks: GoogleComputeResourcePolicySnapshotSchedulePolicyScheduleWeeklyScheduleDayOfWeeks[];
}
...
export class GoogleComputeResourcePolicy extends TerraformResource {
  ...
  private _groupPlacementPolicy?: GoogleComputeResourcePolicyGroupPlacementPolicy[];
  public get groupPlacementPolicy() {
    return this._groupPlacementPolicy;
  }
  public set groupPlacementPolicy(value: GoogleComputeResourcePolicyGroupPlacementPolicy[] | undefined) {
    this._groupPlacementPolicy = value;
  }

  // snapshot_schedule_policy - computed: false, optional: true, required: false
  private _snapshotSchedulePolicy?: GoogleComputeResourcePolicySnapshotSchedulePolicy[];
  public get snapshotSchedulePolicy() {
    return this._snapshotSchedulePolicy;
  }
  public set snapshotSchedulePolicy(value: GoogleComputeResourcePolicySnapshotSchedulePolicy[] | undefined) {
    this._snapshotSchedulePolicy = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleComputeResourcePolicyTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleComputeResourcePolicyTimeouts | undefined) {
