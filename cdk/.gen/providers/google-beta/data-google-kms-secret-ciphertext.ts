// https://www.terraform.io/docs/providers/google-beta/r/data_google_kms_secret_ciphertext_a.html
...
export interface DataGoogleKmsSecretCiphertextAConfig extends TerraformMetaArguments {
...
export class DataGoogleKmsSecretCiphertextA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleKmsSecretCiphertextAConfig) {
    super(scope, id, {
