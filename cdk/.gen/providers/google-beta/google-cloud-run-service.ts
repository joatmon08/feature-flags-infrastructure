// https://www.terraform.io/docs/providers/google-beta/r/google_cloud_run_service.html
...
export interface GoogleCloudRunServiceConfig extends TerraformMetaArguments {
...
More info: http://kubernetes.io/docs/user-guide/identifiers#names */
  ...
  /** traffic block */
  readonly traffic?: GoogleCloudRunServiceTraffic[];
}
export class GoogleCloudRunServiceStatusConditions extends ComplexComputedList {
...
export class GoogleCloudRunServiceStatus extends ComplexComputedList {
...
might be configured in the container image. */
  ...
  /** env block */
  readonly env?: GoogleCloudRunServiceTemplateSpecContainersEnv[];
  /** env_from block */
  readonly envFrom?: GoogleCloudRunServiceTemplateSpecContainersEnvFrom[];
  /** ports block */
  readonly ports?: GoogleCloudRunServiceTemplateSpecContainersPorts[];
  /** resources block */
...
will use the project's default service account. */
  ...
  /** containers block */
  readonly containers?: GoogleCloudRunServiceTemplateSpecContainers[];
}
...
export class GoogleCloudRunService extends TerraformResource {
  ...
  public status(index: string) {
    return new GoogleCloudRunServiceStatus(this, 'status', index);
  }

  // metadata - computed: false, optional: true, required: false
  private _metadata?: GoogleCloudRunServiceMetadata[];
  public get metadata() {
    return this._metadata;
  }
  public set metadata(value: GoogleCloudRunServiceMetadata[] | undefined) {
    this._metadata = value;
  }

  // template - computed: false, optional: true, required: false
  private _template?: GoogleCloudRunServiceTemplate[];
  public get template() {
    return this._template;
  }
  public set template(value: GoogleCloudRunServiceTemplate[] | undefined) {
    this._template = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleCloudRunServiceTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleCloudRunServiceTimeouts | undefined) {
    this._timeouts = value;
  }

  // traffic - computed: false, optional: true, required: false
  private _traffic?: GoogleCloudRunServiceTraffic[];
  public get traffic() {
    return this._traffic;
  }
  public set traffic(value: GoogleCloudRunServiceTraffic[] | undefined) {
    this._traffic = value;
  }
