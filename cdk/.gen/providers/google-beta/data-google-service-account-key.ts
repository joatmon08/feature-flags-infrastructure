// https://www.terraform.io/docs/providers/google-beta/r/data_google_service_account_key_a.html
...
export interface DataGoogleServiceAccountKeyAConfig extends TerraformMetaArguments {
...
export class DataGoogleServiceAccountKeyA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleServiceAccountKeyAConfig) {
    super(scope, id, {
