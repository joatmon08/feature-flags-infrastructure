// https://www.terraform.io/docs/providers/google-beta/r/data_google_kms_crypto_key_a.html
...
export interface DataGoogleKmsCryptoKeyAConfig extends TerraformMetaArguments {
...
export class DataGoogleKmsCryptoKeyVersionTemplateA extends ComplexComputedList {
...
export class DataGoogleKmsCryptoKeyA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleKmsCryptoKeyAConfig) {
    super(scope, id, {
  ...
  public versionTemplate(index: string) {
    return new DataGoogleKmsCryptoKeyVersionTemplateA(this, 'version_template', index);
  }
