// https://www.terraform.io/docs/providers/google-beta/r/google_compute_per_instance_config.html
...
export interface GoogleComputePerInstanceConfigConfig extends TerraformMetaArguments {
...
export interface GoogleComputePerInstanceConfigPreservedState {
  ...
  /** disk block */
  readonly disk?: GoogleComputePerInstanceConfigPreservedStateDisk[];
}
...
export class GoogleComputePerInstanceConfig extends TerraformResource {
  ...
  private _preservedState?: GoogleComputePerInstanceConfigPreservedState[];
  public get preservedState() {
    return this._preservedState;
  }
  public set preservedState(value: GoogleComputePerInstanceConfigPreservedState[] | undefined) {
    this._preservedState = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleComputePerInstanceConfigTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleComputePerInstanceConfigTimeouts | undefined) {
