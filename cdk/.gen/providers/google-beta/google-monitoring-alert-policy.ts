// https://www.terraform.io/docs/providers/google-beta/r/google_monitoring_alert_policy.html
...
export interface GoogleMonitoringAlertPolicyConfig extends TerraformMetaArguments {
...
must begin with a letter. */
  ...
  /** conditions block */
  readonly conditions: GoogleMonitoringAlertPolicyConditions[];
  /** documentation block */
  readonly documentation?: GoogleMonitoringAlertPolicyDocumentation[];
  /** timeouts block */
  readonly timeouts?: GoogleMonitoringAlertPolicyTimeouts;
}
export class GoogleMonitoringAlertPolicyCreationRecord extends ComplexComputedList {
...
in length. */
  ...
  /** aggregations block */
  readonly aggregations?: GoogleMonitoringAlertPolicyConditionsConditionAbsentAggregations[];
  /** trigger block */
...
series. */
  ...
  /** aggregations block */
  readonly aggregations?: GoogleMonitoringAlertPolicyConditionsConditionThresholdAggregations[];
  /** denominator_aggregations block */
  readonly denominatorAggregations?: GoogleMonitoringAlertPolicyConditionsConditionThresholdDenominatorAggregations[];
  /** trigger block */
...
export class GoogleMonitoringAlertPolicy extends TerraformResource {
  ...
  public creationRecord(index: string) {
    return new GoogleMonitoringAlertPolicyCreationRecord(this, 'creation_record', index);
  }
  ...
  private _conditions: GoogleMonitoringAlertPolicyConditions[];
  public get conditions() {
    return this._conditions;
  }
  public set conditions(value: GoogleMonitoringAlertPolicyConditions[]) {
    this._conditions = value;
  }

  // documentation - computed: false, optional: true, required: false
  private _documentation?: GoogleMonitoringAlertPolicyDocumentation[];
  public get documentation() {
    return this._documentation;
  }
  public set documentation(value: GoogleMonitoringAlertPolicyDocumentation[] | undefined) {
    this._documentation = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleMonitoringAlertPolicyTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleMonitoringAlertPolicyTimeouts | undefined) {
