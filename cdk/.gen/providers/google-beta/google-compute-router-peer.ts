// https://www.terraform.io/docs/providers/google-beta/r/google_compute_router_peer.html
...
export interface GoogleComputeRouterPeerConfig extends TerraformMetaArguments {
...
If it is not provided, the provider region is used. */
  ...
  readonly advertisedIpRanges?: GoogleComputeRouterPeerAdvertisedIpRanges[];
  /** timeouts block */
...
export class GoogleComputeRouterPeer extends TerraformResource {
  ...
  private _advertisedIpRanges?: GoogleComputeRouterPeerAdvertisedIpRanges[];
  public get advertisedIpRanges() {
    return this._advertisedIpRanges;
  }
  public set advertisedIpRanges(value: GoogleComputeRouterPeerAdvertisedIpRanges[] | undefined) {
    this._advertisedIpRanges = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleComputeRouterPeerTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleComputeRouterPeerTimeouts | undefined) {
