// https://www.terraform.io/docs/providers/google-beta/r/google_access_context_manager_service_perimeter.html
...
export interface GoogleAccessContextManagerServicePerimeterConfig extends TerraformMetaArguments {
...
export class GoogleAccessContextManagerServicePerimeter extends TerraformResource {
  ...
  private _spec?: GoogleAccessContextManagerServicePerimeterSpec[];
  public get spec() {
    return this._spec;
  }
  public set spec(value: GoogleAccessContextManagerServicePerimeterSpec[] | undefined) {
    this._spec = value;
  }

  // status - computed: false, optional: true, required: false
  private _status?: GoogleAccessContextManagerServicePerimeterStatus[];
  public get status() {
    return this._status;
  }
  public set status(value: GoogleAccessContextManagerServicePerimeterStatus[] | undefined) {
    this._status = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleAccessContextManagerServicePerimeterTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleAccessContextManagerServicePerimeterTimeouts | undefined) {
