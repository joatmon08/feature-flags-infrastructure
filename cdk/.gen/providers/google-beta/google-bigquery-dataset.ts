// https://www.terraform.io/docs/providers/google-beta/r/google_bigquery_dataset.html
...
export interface GoogleBigqueryDatasetConfig extends TerraformMetaArguments {
...
Changing this forces a new resource to be created. */
  ...
  /** access block */
  readonly access?: GoogleBigqueryDatasetAccess[];
...
export class GoogleBigqueryDataset extends TerraformResource {
  ...
  private _access?: GoogleBigqueryDatasetAccess[];
  public get access() {
    return this._access;
  }
  public set access(value: GoogleBigqueryDatasetAccess[] | undefined) {
    this._access = value;
  }

  // default_encryption_configuration - computed: false, optional: true, required: false
  private _defaultEncryptionConfiguration?: GoogleBigqueryDatasetDefaultEncryptionConfiguration[];
  public get defaultEncryptionConfiguration() {
    return this._defaultEncryptionConfiguration;
  }
  public set defaultEncryptionConfiguration(value: GoogleBigqueryDatasetDefaultEncryptionConfiguration[] | undefined) {
    this._defaultEncryptionConfiguration = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleBigqueryDatasetTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleBigqueryDatasetTimeouts | undefined) {
