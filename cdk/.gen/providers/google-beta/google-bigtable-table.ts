// https://www.terraform.io/docs/providers/google-beta/r/google_bigtable_table.html
...
export interface GoogleBigtableTableConfig extends TerraformMetaArguments {
  ...
  /** column_family block */
  readonly columnFamily?: GoogleBigtableTableColumnFamily[];
}
...
export class GoogleBigtableTable extends TerraformResource {
  ...
  private _columnFamily?: GoogleBigtableTableColumnFamily[];
  public get columnFamily() {
    return this._columnFamily;
  }
  public set columnFamily(value: GoogleBigtableTableColumnFamily[] | undefined) {
