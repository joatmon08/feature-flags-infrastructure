// https://www.terraform.io/docs/providers/google-beta/r/data_google_compute_instance_a.html
...
export interface DataGoogleComputeInstanceAConfig extends TerraformMetaArguments {
...
export class DataGoogleComputeInstanceAttachedDiskA extends ComplexComputedList {
...
export class DataGoogleComputeInstanceBootDiskInitializeParamsA extends ComplexComputedList {
...
export class DataGoogleComputeInstanceBootDiskA extends ComplexComputedList {
...
export class DataGoogleComputeInstanceGuestAcceleratorA extends ComplexComputedList {
...
export class DataGoogleComputeInstanceNetworkInterfaceAccessConfigA extends ComplexComputedList {
...
export class DataGoogleComputeInstanceNetworkInterfaceAliasIpRangeA extends ComplexComputedList {
...
export class DataGoogleComputeInstanceNetworkInterfaceA extends ComplexComputedList {
...
export class DataGoogleComputeInstanceSchedulingNodeAffinitiesA extends ComplexComputedList {
...
export class DataGoogleComputeInstanceSchedulingA extends ComplexComputedList {
  ...
  // min_node_cpus - computed: true, optional: false, required: true
...
export class DataGoogleComputeInstanceScratchDiskA extends ComplexComputedList {
...
export class DataGoogleComputeInstanceServiceAccountA extends ComplexComputedList {
...
export class DataGoogleComputeInstanceShieldedInstanceConfigA extends ComplexComputedList {
...
export class DataGoogleComputeInstanceA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleComputeInstanceAConfig = {}) {
    super(scope, id, {
  ...
  public attachedDisk(index: string) {
    return new DataGoogleComputeInstanceAttachedDiskA(this, 'attached_disk', index);
  }

  // boot_disk - computed: true, optional: false, required: true
  public bootDisk(index: string) {
    return new DataGoogleComputeInstanceBootDiskA(this, 'boot_disk', index);
  }
  ...
  public guestAccelerator(index: string) {
    return new DataGoogleComputeInstanceGuestAcceleratorA(this, 'guest_accelerator', index);
  }
  ...
  public networkInterface(index: string) {
    return new DataGoogleComputeInstanceNetworkInterfaceA(this, 'network_interface', index);
  }
  ...
  public scheduling(index: string) {
    return new DataGoogleComputeInstanceSchedulingA(this, 'scheduling', index);
  }

  // scratch_disk - computed: true, optional: false, required: true
  public scratchDisk(index: string) {
    return new DataGoogleComputeInstanceScratchDiskA(this, 'scratch_disk', index);
  }
  ...
  public serviceAccount(index: string) {
    return new DataGoogleComputeInstanceServiceAccountA(this, 'service_account', index);
  }

  // shielded_instance_config - computed: true, optional: false, required: true
  public shieldedInstanceConfig(index: string) {
    return new DataGoogleComputeInstanceShieldedInstanceConfigA(this, 'shielded_instance_config', index);
  }
