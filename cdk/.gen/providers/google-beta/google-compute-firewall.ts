// https://www.terraform.io/docs/providers/google-beta/r/google_compute_firewall.html
...
export interface GoogleComputeFirewallConfig extends TerraformMetaArguments {
...
instances on the specified network. */
  ...
  /** allow block */
  readonly allow?: GoogleComputeFirewallAllow[];
  /** deny block */
  readonly deny?: GoogleComputeFirewallDeny[];
  /** log_config block */
...
export class GoogleComputeFirewall extends TerraformResource {
  ...
  private _allow?: GoogleComputeFirewallAllow[];
  public get allow() {
    return this._allow;
  }
  public set allow(value: GoogleComputeFirewallAllow[] | undefined) {
    this._allow = value;
  }

  // deny - computed: false, optional: true, required: false
  private _deny?: GoogleComputeFirewallDeny[];
  public get deny() {
    return this._deny;
  }
  public set deny(value: GoogleComputeFirewallDeny[] | undefined) {
    this._deny = value;
  }

  // log_config - computed: false, optional: true, required: false
  private _logConfig?: GoogleComputeFirewallLogConfig[];
  public get logConfig() {
    return this._logConfig;
  }
  public set logConfig(value: GoogleComputeFirewallLogConfig[] | undefined) {
    this._logConfig = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleComputeFirewallTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleComputeFirewallTimeouts | undefined) {
