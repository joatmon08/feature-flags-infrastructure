// https://www.terraform.io/docs/providers/google-beta/r/data_google_monitoring_notification_channel_a.html
...
export interface DataGoogleMonitoringNotificationChannelAConfig extends TerraformMetaArguments {
...
export class DataGoogleMonitoringNotificationChannelSensitiveLabelsA extends ComplexComputedList {
...
export class DataGoogleMonitoringNotificationChannelA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleMonitoringNotificationChannelAConfig = {}) {
    super(scope, id, {
  ...
  public sensitiveLabels(index: string) {
    return new DataGoogleMonitoringNotificationChannelSensitiveLabelsA(this, 'sensitive_labels', index);
  }
