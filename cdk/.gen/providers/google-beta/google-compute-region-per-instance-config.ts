// https://www.terraform.io/docs/providers/google-beta/r/google_compute_region_per_instance_config.html
...
export interface GoogleComputeRegionPerInstanceConfigConfig extends TerraformMetaArguments {
...
export interface GoogleComputeRegionPerInstanceConfigPreservedState {
  ...
  /** disk block */
  readonly disk?: GoogleComputeRegionPerInstanceConfigPreservedStateDisk[];
}
...
export class GoogleComputeRegionPerInstanceConfig extends TerraformResource {
  ...
  private _preservedState?: GoogleComputeRegionPerInstanceConfigPreservedState[];
  public get preservedState() {
    return this._preservedState;
  }
  public set preservedState(value: GoogleComputeRegionPerInstanceConfigPreservedState[] | undefined) {
    this._preservedState = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleComputeRegionPerInstanceConfigTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleComputeRegionPerInstanceConfigTimeouts | undefined) {
