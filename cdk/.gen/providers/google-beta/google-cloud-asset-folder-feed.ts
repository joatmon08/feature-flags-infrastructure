// https://www.terraform.io/docs/providers/google-beta/r/google_cloud_asset_folder_feed.html
...
export interface GoogleCloudAssetFolderFeedConfig extends TerraformMetaArguments {
...
export class GoogleCloudAssetFolderFeed extends TerraformResource {
  ...
  private _feedOutputConfig: GoogleCloudAssetFolderFeedFeedOutputConfig[];
  public get feedOutputConfig() {
    return this._feedOutputConfig;
  }
  public set feedOutputConfig(value: GoogleCloudAssetFolderFeedFeedOutputConfig[]) {
    this._feedOutputConfig = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleCloudAssetFolderFeedTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleCloudAssetFolderFeedTimeouts | undefined) {
