// https://www.terraform.io/docs/providers/google-beta/r/google_logging_project_sink.html
...
export interface GoogleLoggingProjectSinkConfig extends TerraformMetaArguments {
...
export class GoogleLoggingProjectSink extends TerraformResource {
  ...
  private _bigqueryOptions?: GoogleLoggingProjectSinkBigqueryOptions[];
  public get bigqueryOptions() {
    return this._bigqueryOptions;
  }
  public set bigqueryOptions(value: GoogleLoggingProjectSinkBigqueryOptions[] | undefined) {
