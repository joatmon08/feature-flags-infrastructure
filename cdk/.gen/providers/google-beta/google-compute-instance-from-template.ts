// https://www.terraform.io/docs/providers/google-beta/r/google_compute_instance_from_template.html
...
export interface GoogleComputeInstanceFromTemplateConfig extends TerraformMetaArguments {
  /** If true, allows Terraform to stop the instance to update its properties. If you try to update a property that requires stopping the instance without setting this field, the update will fail. */
  readonly allowStoppingForUpdate?: boolean;
  /** List of disks attached to the instance */
  readonly attachedDisk?: GoogleComputeInstanceFromTemplateAttachedDisk[];
  ...
  readonly guestAccelerator?: GoogleComputeInstanceFromTemplateGuestAccelerator[];
  ...
  readonly scratchDisk?: GoogleComputeInstanceFromTemplateScratchDisk[];
  /** The service account to attach to the instance. */
  readonly serviceAccount?: GoogleComputeInstanceFromTemplateServiceAccount[];
  ...
  readonly networkInterface?: GoogleComputeInstanceFromTemplateNetworkInterface[];
  /** scheduling block */
...
export interface GoogleComputeInstanceFromTemplateNetworkInterface {
  ...
  readonly accessConfig?: GoogleComputeInstanceFromTemplateNetworkInterfaceAccessConfig[];
  /** An array of alias IP ranges for this network interface. */
  readonly aliasIpRange?: GoogleComputeInstanceFromTemplateNetworkInterfaceAliasIpRange[];
...
export interface GoogleComputeInstanceFromTemplateScheduling {
  ...
  readonly nodeAffinities?: GoogleComputeInstanceFromTemplateSchedulingNodeAffinities[];
}
...
export class GoogleComputeInstanceFromTemplate extends TerraformResource {
  ...
  private _attachedDisk?: GoogleComputeInstanceFromTemplateAttachedDisk[]
  public get attachedDisk(): GoogleComputeInstanceFromTemplateAttachedDisk[] | undefined {
    return this._attachedDisk; // Getting the computed value is not yet implemented
  }
  public set attachedDisk(value: GoogleComputeInstanceFromTemplateAttachedDisk[] | undefined) {
  ...
  private _guestAccelerator?: GoogleComputeInstanceFromTemplateGuestAccelerator[]
  public get guestAccelerator(): GoogleComputeInstanceFromTemplateGuestAccelerator[] | undefined {
    return this._guestAccelerator; // Getting the computed value is not yet implemented
  }
  public set guestAccelerator(value: GoogleComputeInstanceFromTemplateGuestAccelerator[] | undefined) {
  ...
  private _scratchDisk?: GoogleComputeInstanceFromTemplateScratchDisk[]
  public get scratchDisk(): GoogleComputeInstanceFromTemplateScratchDisk[] | undefined {
    return this._scratchDisk; // Getting the computed value is not yet implemented
  }
  public set scratchDisk(value: GoogleComputeInstanceFromTemplateScratchDisk[] | undefined) {
  ...
  private _serviceAccount?: GoogleComputeInstanceFromTemplateServiceAccount[]
  public get serviceAccount(): GoogleComputeInstanceFromTemplateServiceAccount[] | undefined {
    return this._serviceAccount; // Getting the computed value is not yet implemented
  }
  public set serviceAccount(value: GoogleComputeInstanceFromTemplateServiceAccount[] | undefined) {
  ...
  private _bootDisk?: GoogleComputeInstanceFromTemplateBootDisk[];
  public get bootDisk() {
    return this._bootDisk;
  }
  public set bootDisk(value: GoogleComputeInstanceFromTemplateBootDisk[] | undefined) {
    this._bootDisk = value;
  }

  // network_interface - computed: false, optional: true, required: false
  private _networkInterface?: GoogleComputeInstanceFromTemplateNetworkInterface[];
  public get networkInterface() {
    return this._networkInterface;
  }
  public set networkInterface(value: GoogleComputeInstanceFromTemplateNetworkInterface[] | undefined) {
    this._networkInterface = value;
  }

  // scheduling - computed: false, optional: true, required: false
  private _scheduling?: GoogleComputeInstanceFromTemplateScheduling[];
  public get scheduling() {
    return this._scheduling;
  }
  public set scheduling(value: GoogleComputeInstanceFromTemplateScheduling[] | undefined) {
    this._scheduling = value;
  }

  // shielded_instance_config - computed: false, optional: true, required: false
  private _shieldedInstanceConfig?: GoogleComputeInstanceFromTemplateShieldedInstanceConfig[];
  public get shieldedInstanceConfig() {
    return this._shieldedInstanceConfig;
  }
  public set shieldedInstanceConfig(value: GoogleComputeInstanceFromTemplateShieldedInstanceConfig[] | undefined) {
    this._shieldedInstanceConfig = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleComputeInstanceFromTemplateTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleComputeInstanceFromTemplateTimeouts | undefined) {
