// https://www.terraform.io/docs/providers/google-beta/r/data_google_storage_object_signed_url_a.html
...
export interface DataGoogleStorageObjectSignedUrlAConfig extends TerraformMetaArguments {
...
export class DataGoogleStorageObjectSignedUrlA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleStorageObjectSignedUrlAConfig) {
    super(scope, id, {
