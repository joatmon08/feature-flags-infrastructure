// https://www.terraform.io/docs/providers/google-beta/r/google_healthcare_fhir_store.html
...
export interface GoogleHealthcareFhirStoreConfig extends TerraformMetaArguments {
...
** Changing this property may recreate the FHIR store (removing all data) ** */
  ...
  readonly streamConfigs?: GoogleHealthcareFhirStoreStreamConfigs[];
  /** timeouts block */
...
export class GoogleHealthcareFhirStore extends TerraformResource {
  ...
  private _notificationConfig?: GoogleHealthcareFhirStoreNotificationConfig[];
  public get notificationConfig() {
    return this._notificationConfig;
  }
  public set notificationConfig(value: GoogleHealthcareFhirStoreNotificationConfig[] | undefined) {
    this._notificationConfig = value;
  }

  // stream_configs - computed: false, optional: true, required: false
  private _streamConfigs?: GoogleHealthcareFhirStoreStreamConfigs[];
  public get streamConfigs() {
    return this._streamConfigs;
  }
  public set streamConfigs(value: GoogleHealthcareFhirStoreStreamConfigs[] | undefined) {
    this._streamConfigs = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleHealthcareFhirStoreTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleHealthcareFhirStoreTimeouts | undefined) {
