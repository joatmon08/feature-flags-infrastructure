// https://www.terraform.io/docs/providers/google-beta/r/data_google_storage_project_service_account_a.html
...
export interface DataGoogleStorageProjectServiceAccountAConfig extends TerraformMetaArguments {
...
export class DataGoogleStorageProjectServiceAccountA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleStorageProjectServiceAccountAConfig = {}) {
    super(scope, id, {
