// https://www.terraform.io/docs/providers/google-beta/r/google_kms_crypto_key.html
...
export interface GoogleKmsCryptoKeyConfig extends TerraformMetaArguments {
...
export class GoogleKmsCryptoKey extends TerraformResource {
  ...
  private _timeouts?: GoogleKmsCryptoKeyTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleKmsCryptoKeyTimeouts | undefined) {
    this._timeouts = value;
  }

  // version_template - computed: false, optional: true, required: false
  private _versionTemplate?: GoogleKmsCryptoKeyVersionTemplate[];
  public get versionTemplate() {
    return this._versionTemplate;
  }
  public set versionTemplate(value: GoogleKmsCryptoKeyVersionTemplate[] | undefined) {
