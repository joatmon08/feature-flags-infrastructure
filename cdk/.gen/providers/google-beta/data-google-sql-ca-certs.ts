// https://www.terraform.io/docs/providers/google-beta/r/data_google_sql_ca_certs_a.html
...
export interface DataGoogleSqlCaCertsAConfig extends TerraformMetaArguments {
  readonly instance: string;
  readonly project?: string;
}
export class DataGoogleSqlCaCertsCertsA extends ComplexComputedList {
...
export class DataGoogleSqlCaCertsA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleSqlCaCertsAConfig) {
    super(scope, id, {
  ...
  public certs(index: string) {
    return new DataGoogleSqlCaCertsCertsA(this, 'certs', index);
  }
