// https://www.terraform.io/docs/providers/google-beta/r/data_google_redis_instance_a.html
...
export interface DataGoogleRedisInstanceAConfig extends TerraformMetaArguments {
...
export class DataGoogleRedisInstanceA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleRedisInstanceAConfig) {
    super(scope, id, {
