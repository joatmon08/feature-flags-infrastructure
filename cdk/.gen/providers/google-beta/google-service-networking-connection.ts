// https://www.terraform.io/docs/providers/google-beta/r/google_service_networking_connection.html
...
export interface GoogleServiceNetworkingConnectionConfig extends TerraformMetaArguments {
...
export class GoogleServiceNetworkingConnection extends TerraformResource {
  ...
  private _timeouts?: GoogleServiceNetworkingConnectionTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleServiceNetworkingConnectionTimeouts | undefined) {
