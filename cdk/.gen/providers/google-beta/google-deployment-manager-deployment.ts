// https://www.terraform.io/docs/providers/google-beta/r/google_deployment_manager_deployment.html
...
export interface GoogleDeploymentManagerDeploymentConfig extends TerraformMetaArguments {
...
to true or if other fields are updated while preview is true. */
  ...
  /** labels block */
  readonly labels?: GoogleDeploymentManagerDeploymentLabels[];
  /** target block */
...
export interface GoogleDeploymentManagerDeploymentTarget {
  ...
  /** imports block */
  readonly imports?: GoogleDeploymentManagerDeploymentTargetImports[];
}
...
export class GoogleDeploymentManagerDeployment extends TerraformResource {
  ...
  private _labels?: GoogleDeploymentManagerDeploymentLabels[];
  public get labels() {
    return this._labels;
  }
  public set labels(value: GoogleDeploymentManagerDeploymentLabels[] | undefined) {
    this._labels = value;
  }

  // target - computed: false, optional: false, required: true
  private _target: GoogleDeploymentManagerDeploymentTarget[];
  public get target() {
    return this._target;
  }
  public set target(value: GoogleDeploymentManagerDeploymentTarget[]) {
    this._target = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleDeploymentManagerDeploymentTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleDeploymentManagerDeploymentTimeouts | undefined) {
