// https://www.terraform.io/docs/providers/google-beta/r/google_monitoring_uptime_check_config.html
...
export interface GoogleMonitoringUptimeCheckConfigConfig extends TerraformMetaArguments {
  ...
  readonly contentMatchers?: GoogleMonitoringUptimeCheckConfigContentMatchers[];
  /** http_check block */
  readonly httpCheck?: GoogleMonitoringUptimeCheckConfigHttpCheck[];
  /** internal_checkers block */
  readonly internalCheckers?: GoogleMonitoringUptimeCheckConfigInternalCheckers[];
...
export interface GoogleMonitoringUptimeCheckConfigInternalCheckers {
  readonly displayName?: string;
...
export class GoogleMonitoringUptimeCheckConfig extends TerraformResource {
  ...
  private _contentMatchers?: GoogleMonitoringUptimeCheckConfigContentMatchers[];
  public get contentMatchers() {
    return this._contentMatchers;
  }
  public set contentMatchers(value: GoogleMonitoringUptimeCheckConfigContentMatchers[] | undefined) {
    this._contentMatchers = value;
  }

  // http_check - computed: false, optional: true, required: false
  private _httpCheck?: GoogleMonitoringUptimeCheckConfigHttpCheck[];
  public get httpCheck() {
    return this._httpCheck;
  }
  public set httpCheck(value: GoogleMonitoringUptimeCheckConfigHttpCheck[] | undefined) {
    this._httpCheck = value;
  }

  // internal_checkers - computed: false, optional: true, required: false
  private _internalCheckers?: GoogleMonitoringUptimeCheckConfigInternalCheckers[];
  public get internalCheckers() {
    return this._internalCheckers;
  }
  public set internalCheckers(value: GoogleMonitoringUptimeCheckConfigInternalCheckers[] | undefined) {
    this._internalCheckers = value;
  }

  // monitored_resource - computed: false, optional: true, required: false
  private _monitoredResource?: GoogleMonitoringUptimeCheckConfigMonitoredResource[];
  public get monitoredResource() {
    return this._monitoredResource;
  }
  public set monitoredResource(value: GoogleMonitoringUptimeCheckConfigMonitoredResource[] | undefined) {
    this._monitoredResource = value;
  }

  // resource_group - computed: false, optional: true, required: false
  private _resourceGroup?: GoogleMonitoringUptimeCheckConfigResourceGroup[];
  public get resourceGroup() {
    return this._resourceGroup;
  }
  public set resourceGroup(value: GoogleMonitoringUptimeCheckConfigResourceGroup[] | undefined) {
    this._resourceGroup = value;
  }

  // tcp_check - computed: false, optional: true, required: false
  private _tcpCheck?: GoogleMonitoringUptimeCheckConfigTcpCheck[];
  public get tcpCheck() {
    return this._tcpCheck;
  }
  public set tcpCheck(value: GoogleMonitoringUptimeCheckConfigTcpCheck[] | undefined) {
    this._tcpCheck = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleMonitoringUptimeCheckConfigTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleMonitoringUptimeCheckConfigTimeouts | undefined) {
