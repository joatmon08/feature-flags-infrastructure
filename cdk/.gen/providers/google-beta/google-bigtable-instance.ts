// https://www.terraform.io/docs/providers/google-beta/r/google_bigtable_instance.html
...
export interface GoogleBigtableInstanceConfig extends TerraformMetaArguments {
  ...
  /** cluster block */
  readonly cluster?: GoogleBigtableInstanceCluster[];
}
...
export class GoogleBigtableInstance extends TerraformResource {
  ...
  private _cluster?: GoogleBigtableInstanceCluster[];
  public get cluster() {
    return this._cluster;
  }
  public set cluster(value: GoogleBigtableInstanceCluster[] | undefined) {
    this._cluster = value;
  }
