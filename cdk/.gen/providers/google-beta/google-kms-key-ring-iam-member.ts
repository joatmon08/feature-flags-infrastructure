// https://www.terraform.io/docs/providers/google-beta/r/google_kms_key_ring_iam_member.html
...
export interface GoogleKmsKeyRingIamMemberConfig extends TerraformMetaArguments {
...
export class GoogleKmsKeyRingIamMember extends TerraformResource {
  ...
  private _condition?: GoogleKmsKeyRingIamMemberCondition[];
  public get condition() {
    return this._condition;
  }
  public set condition(value: GoogleKmsKeyRingIamMemberCondition[] | undefined) {
