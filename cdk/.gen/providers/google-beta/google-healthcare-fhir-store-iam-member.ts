// https://www.terraform.io/docs/providers/google-beta/r/google_healthcare_fhir_store_iam_member.html
...
export interface GoogleHealthcareFhirStoreIamMemberConfig extends TerraformMetaArguments {
...
export class GoogleHealthcareFhirStoreIamMember extends TerraformResource {
  ...
  private _condition?: GoogleHealthcareFhirStoreIamMemberCondition[];
  public get condition() {
    return this._condition;
  }
  public set condition(value: GoogleHealthcareFhirStoreIamMemberCondition[] | undefined) {
