// https://www.terraform.io/docs/providers/google-beta/r/google_access_context_manager_service_perimeter_resource.html
...
export interface GoogleAccessContextManagerServicePerimeterResourceConfig extends TerraformMetaArguments {
...
export class GoogleAccessContextManagerServicePerimeterResource extends TerraformResource {
  ...
  private _timeouts?: GoogleAccessContextManagerServicePerimeterResourceTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleAccessContextManagerServicePerimeterResourceTimeouts | undefined) {
