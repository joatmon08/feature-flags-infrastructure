// https://www.terraform.io/docs/providers/google-beta/r/google_dataproc_job.html
...
export interface GoogleDataprocJobConfig extends TerraformMetaArguments {
...
export class GoogleDataprocJobStatus extends ComplexComputedList {
...
export class GoogleDataprocJob extends TerraformResource {
  ...
  public status(index: string) {
    return new GoogleDataprocJobStatus(this, 'status', index);
  }

  // hadoop_config - computed: false, optional: true, required: false
  private _hadoopConfig?: GoogleDataprocJobHadoopConfig[];
  public get hadoopConfig() {
    return this._hadoopConfig;
  }
  public set hadoopConfig(value: GoogleDataprocJobHadoopConfig[] | undefined) {
    this._hadoopConfig = value;
  }

  // hive_config - computed: false, optional: true, required: false
  private _hiveConfig?: GoogleDataprocJobHiveConfig[];
  public get hiveConfig() {
    return this._hiveConfig;
  }
  public set hiveConfig(value: GoogleDataprocJobHiveConfig[] | undefined) {
    this._hiveConfig = value;
  }

  // pig_config - computed: false, optional: true, required: false
  private _pigConfig?: GoogleDataprocJobPigConfig[];
  public get pigConfig() {
    return this._pigConfig;
  }
  public set pigConfig(value: GoogleDataprocJobPigConfig[] | undefined) {
    this._pigConfig = value;
  }

  // placement - computed: false, optional: false, required: true
  private _placement: GoogleDataprocJobPlacement[];
  public get placement() {
    return this._placement;
  }
  public set placement(value: GoogleDataprocJobPlacement[]) {
    this._placement = value;
  }

  // pyspark_config - computed: false, optional: true, required: false
  private _pysparkConfig?: GoogleDataprocJobPysparkConfig[];
  public get pysparkConfig() {
    return this._pysparkConfig;
  }
  public set pysparkConfig(value: GoogleDataprocJobPysparkConfig[] | undefined) {
    this._pysparkConfig = value;
  }

  // reference - computed: false, optional: true, required: false
  private _reference?: GoogleDataprocJobReference[];
  public get reference() {
    return this._reference;
  }
  public set reference(value: GoogleDataprocJobReference[] | undefined) {
    this._reference = value;
  }

  // scheduling - computed: false, optional: true, required: false
  private _scheduling?: GoogleDataprocJobScheduling[];
  public get scheduling() {
    return this._scheduling;
  }
  public set scheduling(value: GoogleDataprocJobScheduling[] | undefined) {
    this._scheduling = value;
  }

  // spark_config - computed: false, optional: true, required: false
  private _sparkConfig?: GoogleDataprocJobSparkConfig[];
  public get sparkConfig() {
    return this._sparkConfig;
  }
  public set sparkConfig(value: GoogleDataprocJobSparkConfig[] | undefined) {
    this._sparkConfig = value;
  }

  // sparksql_config - computed: false, optional: true, required: false
  private _sparksqlConfig?: GoogleDataprocJobSparksqlConfig[];
  public get sparksqlConfig() {
    return this._sparksqlConfig;
  }
  public set sparksqlConfig(value: GoogleDataprocJobSparksqlConfig[] | undefined) {
    this._sparksqlConfig = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleDataprocJobTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleDataprocJobTimeouts | undefined) {
