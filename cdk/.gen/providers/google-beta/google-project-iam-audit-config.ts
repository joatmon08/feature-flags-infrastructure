// https://www.terraform.io/docs/providers/google-beta/r/google_project_iam_audit_config.html
...
export interface GoogleProjectIamAuditConfigConfig extends TerraformMetaArguments {
  readonly project?: string;
  /** Service which will be enabled for audit logging. The special value allServices covers all services. */
  readonly service: string;
  /** audit_log_config block */
  readonly auditLogConfig: GoogleProjectIamAuditConfigAuditLogConfig[];
}
...
export class GoogleProjectIamAuditConfig extends TerraformResource {
  ...
  private _auditLogConfig: GoogleProjectIamAuditConfigAuditLogConfig[];
  public get auditLogConfig() {
    return this._auditLogConfig;
  }
  public set auditLogConfig(value: GoogleProjectIamAuditConfigAuditLogConfig[]) {
