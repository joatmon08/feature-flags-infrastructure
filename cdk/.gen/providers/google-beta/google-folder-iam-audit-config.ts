// https://www.terraform.io/docs/providers/google-beta/r/google_folder_iam_audit_config.html
...
export interface GoogleFolderIamAuditConfigConfig extends TerraformMetaArguments {
  readonly folder: string;
  /** Service which will be enabled for audit logging. The special value allServices covers all services. */
  readonly service: string;
  /** audit_log_config block */
  readonly auditLogConfig: GoogleFolderIamAuditConfigAuditLogConfig[];
}
...
export class GoogleFolderIamAuditConfig extends TerraformResource {
  ...
  private _auditLogConfig: GoogleFolderIamAuditConfigAuditLogConfig[];
  public get auditLogConfig() {
    return this._auditLogConfig;
  }
  public set auditLogConfig(value: GoogleFolderIamAuditConfigAuditLogConfig[]) {
