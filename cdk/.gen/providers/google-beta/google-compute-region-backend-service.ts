// https://www.terraform.io/docs/providers/google-beta/r/google_compute_region_backend_service.html
...
export interface GoogleComputeRegionBackendServiceConfig extends TerraformMetaArguments {
...
failed request. Default is 30 seconds. Valid range is [1, 86400]. */
  ...
  /** backend block */
  readonly backend?: GoogleComputeRegionBackendServiceBackend[];
...
export class GoogleComputeRegionBackendService extends TerraformResource {
  ...
  private _backend?: GoogleComputeRegionBackendServiceBackend[];
  public get backend() {
    return this._backend;
  }
  public set backend(value: GoogleComputeRegionBackendServiceBackend[] | undefined) {
    this._backend = value;
  }

  // circuit_breakers - computed: false, optional: true, required: false
  private _circuitBreakers?: GoogleComputeRegionBackendServiceCircuitBreakers[];
  public get circuitBreakers() {
    return this._circuitBreakers;
  }
  public set circuitBreakers(value: GoogleComputeRegionBackendServiceCircuitBreakers[] | undefined) {
    this._circuitBreakers = value;
  }

  // consistent_hash - computed: false, optional: true, required: false
  private _consistentHash?: GoogleComputeRegionBackendServiceConsistentHash[];
  public get consistentHash() {
    return this._consistentHash;
  }
  public set consistentHash(value: GoogleComputeRegionBackendServiceConsistentHash[] | undefined) {
    this._consistentHash = value;
  }

  // failover_policy - computed: false, optional: true, required: false
  private _failoverPolicy?: GoogleComputeRegionBackendServiceFailoverPolicy[];
  public get failoverPolicy() {
    return this._failoverPolicy;
  }
  public set failoverPolicy(value: GoogleComputeRegionBackendServiceFailoverPolicy[] | undefined) {
    this._failoverPolicy = value;
  }

  // log_config - computed: false, optional: true, required: false
  private _logConfig?: GoogleComputeRegionBackendServiceLogConfig[];
  public get logConfig() {
    return this._logConfig;
  }
  public set logConfig(value: GoogleComputeRegionBackendServiceLogConfig[] | undefined) {
    this._logConfig = value;
  }

  // outlier_detection - computed: false, optional: true, required: false
  private _outlierDetection?: GoogleComputeRegionBackendServiceOutlierDetection[];
  public get outlierDetection() {
    return this._outlierDetection;
  }
  public set outlierDetection(value: GoogleComputeRegionBackendServiceOutlierDetection[] | undefined) {
    this._outlierDetection = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleComputeRegionBackendServiceTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleComputeRegionBackendServiceTimeouts | undefined) {
