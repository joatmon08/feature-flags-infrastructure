// https://www.terraform.io/docs/providers/google-beta/r/google_container_analysis_occurrence.html
...
export interface GoogleContainerAnalysisOccurrenceConfig extends TerraformMetaArguments {
...
more signatures. A base64-encoded string. */
  ...
  /** signatures block */
  readonly signatures: GoogleContainerAnalysisOccurrenceAttestationSignatures[];
}
...
export class GoogleContainerAnalysisOccurrence extends TerraformResource {
  ...
  private _attestation: GoogleContainerAnalysisOccurrenceAttestation[];
  public get attestation() {
    return this._attestation;
  }
  public set attestation(value: GoogleContainerAnalysisOccurrenceAttestation[]) {
    this._attestation = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleContainerAnalysisOccurrenceTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleContainerAnalysisOccurrenceTimeouts | undefined) {
