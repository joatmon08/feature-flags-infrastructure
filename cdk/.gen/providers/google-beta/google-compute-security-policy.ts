// https://www.terraform.io/docs/providers/google-beta/r/google_compute_security_policy.html
...
export interface GoogleComputeSecurityPolicyConfig extends TerraformMetaArguments {
  ...
  /** rule block */
  readonly rule?: GoogleComputeSecurityPolicyRule[];
  /** timeouts block */
...
export class GoogleComputeSecurityPolicy extends TerraformResource {
  ...
  private _rule?: GoogleComputeSecurityPolicyRule[];
  public get rule() {
    return this._rule;
  }
  public set rule(value: GoogleComputeSecurityPolicyRule[] | undefined) {
    this._rule = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleComputeSecurityPolicyTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleComputeSecurityPolicyTimeouts | undefined) {
