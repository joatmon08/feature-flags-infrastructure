// https://www.terraform.io/docs/providers/google-beta/r/data_google_monitoring_app_engine_service_a.html
...
export interface DataGoogleMonitoringAppEngineServiceAConfig extends TerraformMetaArguments {
...
export class DataGoogleMonitoringAppEngineServiceTelemetryA extends ComplexComputedList {
...
export class DataGoogleMonitoringAppEngineServiceA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleMonitoringAppEngineServiceAConfig) {
    super(scope, id, {
  ...
  public telemetry(index: string) {
    return new DataGoogleMonitoringAppEngineServiceTelemetryA(this, 'telemetry', index);
  }
