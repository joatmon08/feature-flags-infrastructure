// https://www.terraform.io/docs/providers/google-beta/r/data_google_compute_forwarding_rule_a.html
...
export interface DataGoogleComputeForwardingRuleAConfig extends TerraformMetaArguments {
...
export class DataGoogleComputeForwardingRuleA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleComputeForwardingRuleAConfig) {
    super(scope, id, {
