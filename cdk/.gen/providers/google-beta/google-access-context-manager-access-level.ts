// https://www.terraform.io/docs/providers/google-beta/r/google_access_context_manager_access_level.html
...
export interface GoogleAccessContextManagerAccessLevelConfig extends TerraformMetaArguments {
...
to be true. Defaults to false. */
  ...
  readonly osConstraints?: GoogleAccessContextManagerAccessLevelBasicConditionsDevicePolicyOsConstraints[];
}
...
for the AccessLevel to be applied. Default value: "AND" Possible values: ["AND", "OR"] */
  ...
  /** conditions block */
  readonly conditions: GoogleAccessContextManagerAccessLevelBasicConditions[];
}
...
export class GoogleAccessContextManagerAccessLevel extends TerraformResource {
  ...
  private _basic?: GoogleAccessContextManagerAccessLevelBasic[];
  public get basic() {
    return this._basic;
  }
  public set basic(value: GoogleAccessContextManagerAccessLevelBasic[] | undefined) {
    this._basic = value;
  }

  // custom - computed: false, optional: true, required: false
  private _custom?: GoogleAccessContextManagerAccessLevelCustom[];
  public get custom() {
    return this._custom;
  }
  public set custom(value: GoogleAccessContextManagerAccessLevelCustom[] | undefined) {
    this._custom = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleAccessContextManagerAccessLevelTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleAccessContextManagerAccessLevelTimeouts | undefined) {
