// https://www.terraform.io/docs/providers/google-beta/r/google_composer_environment.html
...
export interface GoogleComposerEnvironmentConfig extends TerraformMetaArguments {
  ...
  /** config block */
  readonly config?: GoogleComposerEnvironmentConfig[];
  /** timeouts block */
...
export interface GoogleComposerEnvironmentConfigNodeConfig {
  ...
  readonly ipAllocationPolicy?: GoogleComposerEnvironmentConfigNodeConfigIpAllocationPolicy[];
...
export interface GoogleComposerEnvironmentConfigWebServerNetworkAccessControl {
  ...
  readonly allowedIpRange?: GoogleComposerEnvironmentConfigWebServerNetworkAccessControlAllowedIpRange[];
}
export interface GoogleComposerEnvironmentConfig {
...
export class GoogleComposerEnvironment extends TerraformResource {
  ...
  private _config?: GoogleComposerEnvironmentConfig[];
  public get config() {
    return this._config;
  }
  public set config(value: GoogleComposerEnvironmentConfig[] | undefined) {
    this._config = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleComposerEnvironmentTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleComposerEnvironmentTimeouts | undefined) {
