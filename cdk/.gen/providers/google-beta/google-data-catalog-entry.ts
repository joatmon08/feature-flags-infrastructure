// https://www.terraform.io/docs/providers/google-beta/r/google_data_catalog_entry.html
...
export interface GoogleDataCatalogEntryConfig extends TerraformMetaArguments {
...
export class GoogleDataCatalogEntryBigqueryDateShardedSpec extends ComplexComputedList {
...
export class GoogleDataCatalogEntryBigqueryTableSpecTableSpec extends ComplexComputedList {
...
export class GoogleDataCatalogEntryBigqueryTableSpecViewSpec extends ComplexComputedList {
...
export class GoogleDataCatalogEntryBigqueryTableSpec extends ComplexComputedList {
...
export class GoogleDataCatalogEntry extends TerraformResource {
  ...
  public bigqueryDateShardedSpec(index: string) {
    return new GoogleDataCatalogEntryBigqueryDateShardedSpec(this, 'bigquery_date_sharded_spec', index);
  }

  // bigquery_table_spec - computed: true, optional: false, required: true
  public bigqueryTableSpec(index: string) {
    return new GoogleDataCatalogEntryBigqueryTableSpec(this, 'bigquery_table_spec', index);
  }
  ...
  private _gcsFilesetSpec?: GoogleDataCatalogEntryGcsFilesetSpec[];
  public get gcsFilesetSpec() {
    return this._gcsFilesetSpec;
  }
  public set gcsFilesetSpec(value: GoogleDataCatalogEntryGcsFilesetSpec[] | undefined) {
    this._gcsFilesetSpec = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleDataCatalogEntryTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleDataCatalogEntryTimeouts | undefined) {
