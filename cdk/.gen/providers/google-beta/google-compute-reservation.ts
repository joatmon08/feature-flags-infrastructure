// https://www.terraform.io/docs/providers/google-beta/r/google_compute_reservation.html
...
export interface GoogleComputeReservationConfig extends TerraformMetaArguments {
...
for information on available CPU platforms. */
  ...
  readonly guestAccelerators?: GoogleComputeReservationSpecificReservationInstancePropertiesGuestAccelerators[];
  /** local_ssds block */
  readonly localSsds?: GoogleComputeReservationSpecificReservationInstancePropertiesLocalSsds[];
}
...
export class GoogleComputeReservation extends TerraformResource {
  ...
  private _specificReservation: GoogleComputeReservationSpecificReservation[];
  public get specificReservation() {
    return this._specificReservation;
  }
  public set specificReservation(value: GoogleComputeReservationSpecificReservation[]) {
    this._specificReservation = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleComputeReservationTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleComputeReservationTimeouts | undefined) {
