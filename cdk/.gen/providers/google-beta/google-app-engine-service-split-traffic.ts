// https://www.terraform.io/docs/providers/google-beta/r/google_app_engine_service_split_traffic.html
...
export interface GoogleAppEngineServiceSplitTrafficConfig extends TerraformMetaArguments {
...
export class GoogleAppEngineServiceSplitTraffic extends TerraformResource {
  ...
  private _split: GoogleAppEngineServiceSplitTrafficSplit[];
  public get split() {
    return this._split;
  }
  public set split(value: GoogleAppEngineServiceSplitTrafficSplit[]) {
    this._split = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleAppEngineServiceSplitTrafficTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleAppEngineServiceSplitTrafficTimeouts | undefined) {
