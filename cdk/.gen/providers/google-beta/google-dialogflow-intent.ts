// https://www.terraform.io/docs/providers/google-beta/r/google_dialogflow_intent.html
...
export interface GoogleDialogflowIntentConfig extends TerraformMetaArguments {
...
export class GoogleDialogflowIntentFollowupIntentInfo extends ComplexComputedList {
...
export class GoogleDialogflowIntent extends TerraformResource {
  ...
  public followupIntentInfo(index: string) {
    return new GoogleDialogflowIntentFollowupIntentInfo(this, 'followup_intent_info', index);
  }
  ...
  private _timeouts?: GoogleDialogflowIntentTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleDialogflowIntentTimeouts | undefined) {
