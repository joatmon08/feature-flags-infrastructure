// https://www.terraform.io/docs/providers/google-beta/r/data_google_dns_keys_a.html
...
export interface DataGoogleDnsKeysAConfig extends TerraformMetaArguments {
  readonly managedZone: string;
  readonly project?: string;
}
export class DataGoogleDnsKeysKeySigningKeysDigestsA extends ComplexComputedList {
...
export class DataGoogleDnsKeysKeySigningKeysA extends ComplexComputedList {
...
export class DataGoogleDnsKeysZoneSigningKeysDigestsA extends ComplexComputedList {
...
export class DataGoogleDnsKeysZoneSigningKeysA extends ComplexComputedList {
...
export class DataGoogleDnsKeysA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleDnsKeysAConfig) {
    super(scope, id, {
  ...
  public keySigningKeys(index: string) {
    return new DataGoogleDnsKeysKeySigningKeysA(this, 'key_signing_keys', index);
  }
  ...
  public zoneSigningKeys(index: string) {
    return new DataGoogleDnsKeysZoneSigningKeysA(this, 'zone_signing_keys', index);
  }
