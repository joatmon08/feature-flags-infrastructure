// https://www.terraform.io/docs/providers/google-beta/r/google_data_catalog_tag_template.html
...
export interface GoogleDataCatalogTagTemplateConfig extends TerraformMetaArguments {
  ...
  /** fields block */
  readonly fields: GoogleDataCatalogTagTemplateFields[];
  /** timeouts block */
...
export interface GoogleDataCatalogTagTemplateFieldsTypeEnumType {
  ...
  readonly allowedValues: GoogleDataCatalogTagTemplateFieldsTypeEnumTypeAllowedValues[];
}
...
export class GoogleDataCatalogTagTemplate extends TerraformResource {
  ...
  private _fields: GoogleDataCatalogTagTemplateFields[];
  public get fields() {
    return this._fields;
  }
  public set fields(value: GoogleDataCatalogTagTemplateFields[]) {
    this._fields = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleDataCatalogTagTemplateTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleDataCatalogTagTemplateTimeouts | undefined) {
