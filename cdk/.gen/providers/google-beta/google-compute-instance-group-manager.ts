// https://www.terraform.io/docs/providers/google-beta/r/google_compute_instance_group_manager.html
...
export interface GoogleComputeInstanceGroupManagerConfig extends TerraformMetaArguments {
  ...
  /** named_port block */
  readonly namedPort?: GoogleComputeInstanceGroupManagerNamedPort[];
  /** stateful_disk block */
  readonly statefulDisk?: GoogleComputeInstanceGroupManagerStatefulDisk[];
  /** timeouts block */
  ...
  /** version block */
  readonly version: GoogleComputeInstanceGroupManagerVersion[];
}
...
export class GoogleComputeInstanceGroupManager extends TerraformResource {
  ...
  private _autoHealingPolicies?: GoogleComputeInstanceGroupManagerAutoHealingPolicies[];
  public get autoHealingPolicies() {
    return this._autoHealingPolicies;
  }
  public set autoHealingPolicies(value: GoogleComputeInstanceGroupManagerAutoHealingPolicies[] | undefined) {
    this._autoHealingPolicies = value;
  }

  // named_port - computed: false, optional: true, required: false
  private _namedPort?: GoogleComputeInstanceGroupManagerNamedPort[];
  public get namedPort() {
    return this._namedPort;
  }
  public set namedPort(value: GoogleComputeInstanceGroupManagerNamedPort[] | undefined) {
    this._namedPort = value;
  }

  // stateful_disk - computed: false, optional: true, required: false
  private _statefulDisk?: GoogleComputeInstanceGroupManagerStatefulDisk[];
  public get statefulDisk() {
    return this._statefulDisk;
  }
  public set statefulDisk(value: GoogleComputeInstanceGroupManagerStatefulDisk[] | undefined) {
    this._statefulDisk = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleComputeInstanceGroupManagerTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleComputeInstanceGroupManagerTimeouts | undefined) {
    this._timeouts = value;
  }

  // update_policy - computed: false, optional: true, required: false
  private _updatePolicy?: GoogleComputeInstanceGroupManagerUpdatePolicy[];
  public get updatePolicy() {
    return this._updatePolicy;
  }
  public set updatePolicy(value: GoogleComputeInstanceGroupManagerUpdatePolicy[] | undefined) {
    this._updatePolicy = value;
  }

  // version - computed: false, optional: false, required: true
  private _version: GoogleComputeInstanceGroupManagerVersion[];
  public get version() {
    return this._version;
  }
  public set version(value: GoogleComputeInstanceGroupManagerVersion[]) {
    this._version = value;
  }
