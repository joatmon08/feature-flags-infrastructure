// https://www.terraform.io/docs/providers/google-beta/r/google_storage_object_access_control.html
...
export interface GoogleStorageObjectAccessControlConfig extends TerraformMetaArguments {
...
export class GoogleStorageObjectAccessControlProjectTeam extends ComplexComputedList {
...
export class GoogleStorageObjectAccessControl extends TerraformResource {
  ...
  public projectTeam(index: string) {
    return new GoogleStorageObjectAccessControlProjectTeam(this, 'project_team', index);
  }
  ...
  private _timeouts?: GoogleStorageObjectAccessControlTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleStorageObjectAccessControlTimeouts | undefined) {
