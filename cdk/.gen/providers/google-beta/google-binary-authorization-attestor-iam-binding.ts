// https://www.terraform.io/docs/providers/google-beta/r/google_binary_authorization_attestor_iam_binding.html
...
export interface GoogleBinaryAuthorizationAttestorIamBindingConfig extends TerraformMetaArguments {
...
export class GoogleBinaryAuthorizationAttestorIamBinding extends TerraformResource {
  ...
  private _condition?: GoogleBinaryAuthorizationAttestorIamBindingCondition[];
  public get condition() {
    return this._condition;
  }
  public set condition(value: GoogleBinaryAuthorizationAttestorIamBindingCondition[] | undefined) {
