// https://www.terraform.io/docs/providers/google-beta/r/google_compute_image.html
...
export interface GoogleComputeImageConfig extends TerraformMetaArguments {
...
rawDisk.source property but not both to create an image. */
  ...
  readonly guestOsFeatures?: GoogleComputeImageGuestOsFeatures[];
  /** raw_disk block */
...
export class GoogleComputeImage extends TerraformResource {
  ...
  private _guestOsFeatures?: GoogleComputeImageGuestOsFeatures[];
  public get guestOsFeatures() {
    return this._guestOsFeatures;
  }
  public set guestOsFeatures(value: GoogleComputeImageGuestOsFeatures[] | undefined) {
    this._guestOsFeatures = value;
  }

  // raw_disk - computed: false, optional: true, required: false
  private _rawDisk?: GoogleComputeImageRawDisk[];
  public get rawDisk() {
    return this._rawDisk;
  }
  public set rawDisk(value: GoogleComputeImageRawDisk[] | undefined) {
    this._rawDisk = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleComputeImageTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleComputeImageTimeouts | undefined) {
