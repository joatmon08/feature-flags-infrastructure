// https://www.terraform.io/docs/providers/google-beta/r/data_google_iam_testable_permissions_a.html
...
export interface DataGoogleIamTestablePermissionsAConfig extends TerraformMetaArguments {
  readonly customSupportLevel?: string;
  readonly fullResourceName: string;
  readonly stages?: string[];
}
export class DataGoogleIamTestablePermissionsPermissionsA extends ComplexComputedList {
...
export class DataGoogleIamTestablePermissionsA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleIamTestablePermissionsAConfig) {
    super(scope, id, {
  ...
  public permissions(index: string) {
    return new DataGoogleIamTestablePermissionsPermissionsA(this, 'permissions', index);
  }
