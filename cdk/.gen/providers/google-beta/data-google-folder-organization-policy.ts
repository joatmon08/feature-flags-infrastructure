// https://www.terraform.io/docs/providers/google-beta/r/data_google_folder_organization_policy_a.html
...
export interface DataGoogleFolderOrganizationPolicyAConfig extends TerraformMetaArguments {
  /** The name of the Constraint the Policy is configuring, for example, serviceuser.services. */
  readonly constraint: string;
  /** The resource name of the folder to set the policy for. Its format is folders/{folder_id}. */
  readonly folder: string;
}
export class DataGoogleFolderOrganizationPolicyBooleanPolicyA extends ComplexComputedList {
...
export class DataGoogleFolderOrganizationPolicyListPolicyAllowA extends ComplexComputedList {
...
export class DataGoogleFolderOrganizationPolicyListPolicyDenyA extends ComplexComputedList {
...
export class DataGoogleFolderOrganizationPolicyListPolicyA extends ComplexComputedList {
...
export class DataGoogleFolderOrganizationPolicyRestorePolicyA extends ComplexComputedList {
...
export class DataGoogleFolderOrganizationPolicyA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleFolderOrganizationPolicyAConfig) {
    super(scope, id, {
  ...
  public booleanPolicy(index: string) {
    return new DataGoogleFolderOrganizationPolicyBooleanPolicyA(this, 'boolean_policy', index);
  }
  ...
  public listPolicy(index: string) {
    return new DataGoogleFolderOrganizationPolicyListPolicyA(this, 'list_policy', index);
  }

  // restore_policy - computed: true, optional: false, required: true
  public restorePolicy(index: string) {
    return new DataGoogleFolderOrganizationPolicyRestorePolicyA(this, 'restore_policy', index);
  }
