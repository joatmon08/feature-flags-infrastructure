// https://www.terraform.io/docs/providers/google-beta/r/google_compute_forwarding_rule.html
...
export interface GoogleComputeForwardingRuleConfig extends TerraformMetaArguments {
...
export class GoogleComputeForwardingRule extends TerraformResource {
  ...
  public set isMirroringCollector(value: boolean | undefined) {
  ...
  private _timeouts?: GoogleComputeForwardingRuleTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleComputeForwardingRuleTimeouts | undefined) {
  ...
  public synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      is_mirroring_collector: this._isMirroringCollector,
      labels: this._labels,
