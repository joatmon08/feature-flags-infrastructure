// https://www.terraform.io/docs/providers/google-beta/r/google_compute_backend_service.html
...
export interface GoogleComputeBackendServiceConfig extends TerraformMetaArguments {
...
failed request. Default is 30 seconds. Valid range is [1, 86400]. */
  ...
  /** backend block */
  readonly backend?: GoogleComputeBackendServiceBackend[];
  /** cdn_policy block */
...
export class GoogleComputeBackendService extends TerraformResource {
  ...
  private _backend?: GoogleComputeBackendServiceBackend[];
  public get backend() {
    return this._backend;
  }
  public set backend(value: GoogleComputeBackendServiceBackend[] | undefined) {
    this._backend = value;
  }

  // cdn_policy - computed: false, optional: true, required: false
  private _cdnPolicy?: GoogleComputeBackendServiceCdnPolicy[];
  public get cdnPolicy() {
    return this._cdnPolicy;
  }
  public set cdnPolicy(value: GoogleComputeBackendServiceCdnPolicy[] | undefined) {
    this._cdnPolicy = value;
  }

  // circuit_breakers - computed: false, optional: true, required: false
  private _circuitBreakers?: GoogleComputeBackendServiceCircuitBreakers[];
  public get circuitBreakers() {
    return this._circuitBreakers;
  }
  public set circuitBreakers(value: GoogleComputeBackendServiceCircuitBreakers[] | undefined) {
    this._circuitBreakers = value;
  }

  // consistent_hash - computed: false, optional: true, required: false
  private _consistentHash?: GoogleComputeBackendServiceConsistentHash[];
  public get consistentHash() {
    return this._consistentHash;
  }
  public set consistentHash(value: GoogleComputeBackendServiceConsistentHash[] | undefined) {
    this._consistentHash = value;
  }

  // iap - computed: false, optional: true, required: false
  private _iap?: GoogleComputeBackendServiceIap[];
  public get iap() {
    return this._iap;
  }
  public set iap(value: GoogleComputeBackendServiceIap[] | undefined) {
    this._iap = value;
  }

  // log_config - computed: false, optional: true, required: false
  private _logConfig?: GoogleComputeBackendServiceLogConfig[];
  public get logConfig() {
    return this._logConfig;
  }
  public set logConfig(value: GoogleComputeBackendServiceLogConfig[] | undefined) {
    this._logConfig = value;
  }

  // outlier_detection - computed: false, optional: true, required: false
  private _outlierDetection?: GoogleComputeBackendServiceOutlierDetection[];
  public get outlierDetection() {
    return this._outlierDetection;
  }
  public set outlierDetection(value: GoogleComputeBackendServiceOutlierDetection[] | undefined) {
    this._outlierDetection = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleComputeBackendServiceTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleComputeBackendServiceTimeouts | undefined) {
