// https://www.terraform.io/docs/providers/google-beta/r/data_google_secret_manager_secret_version_a.html
...
export interface DataGoogleSecretManagerSecretVersionAConfig extends TerraformMetaArguments {
...
export class DataGoogleSecretManagerSecretVersionA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleSecretManagerSecretVersionAConfig) {
    super(scope, id, {
