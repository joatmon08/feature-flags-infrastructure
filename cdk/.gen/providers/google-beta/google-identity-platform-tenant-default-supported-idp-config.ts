// https://www.terraform.io/docs/providers/google-beta/r/google_identity_platform_tenant_default_supported_idp_config.html
...
export interface GoogleIdentityPlatformTenantDefaultSupportedIdpConfigConfig extends TerraformMetaArguments {
  /** OAuth client ID */
...
export class GoogleIdentityPlatformTenantDefaultSupportedIdpConfig extends TerraformResource {
  ...
  private _timeouts?: GoogleIdentityPlatformTenantDefaultSupportedIdpConfigTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleIdentityPlatformTenantDefaultSupportedIdpConfigTimeouts | undefined) {
