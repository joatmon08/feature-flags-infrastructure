// https://www.terraform.io/docs/providers/google-beta/r/google_binary_authorization_attestor.html
...
export interface GoogleBinaryAuthorizationAttestorConfig extends TerraformMetaArguments {
...
and that links to this Note. */
  ...
  /** public_keys block */
  readonly publicKeys?: GoogleBinaryAuthorizationAttestorAttestationAuthorityNotePublicKeys[];
}
...
export class GoogleBinaryAuthorizationAttestor extends TerraformResource {
  ...
  private _attestationAuthorityNote: GoogleBinaryAuthorizationAttestorAttestationAuthorityNote[];
  public get attestationAuthorityNote() {
    return this._attestationAuthorityNote;
  }
  public set attestationAuthorityNote(value: GoogleBinaryAuthorizationAttestorAttestationAuthorityNote[]) {
    this._attestationAuthorityNote = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleBinaryAuthorizationAttestorTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleBinaryAuthorizationAttestorTimeouts | undefined) {
