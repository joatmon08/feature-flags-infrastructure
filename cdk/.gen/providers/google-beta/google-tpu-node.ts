// https://www.terraform.io/docs/providers/google-beta/r/google_tpu_node.html
...
export interface GoogleTpuNodeConfig extends TerraformMetaArguments {
...
export class GoogleTpuNodeNetworkEndpoints extends ComplexComputedList {
...
export class GoogleTpuNode extends TerraformResource {
  ...
  public networkEndpoints(index: string) {
    return new GoogleTpuNodeNetworkEndpoints(this, 'network_endpoints', index);
  }
  ...
  private _schedulingConfig?: GoogleTpuNodeSchedulingConfig[];
  public get schedulingConfig() {
    return this._schedulingConfig;
  }
  public set schedulingConfig(value: GoogleTpuNodeSchedulingConfig[] | undefined) {
    this._schedulingConfig = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleTpuNodeTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleTpuNodeTimeouts | undefined) {
