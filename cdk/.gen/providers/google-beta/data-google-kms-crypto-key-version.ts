// https://www.terraform.io/docs/providers/google-beta/r/data_google_kms_crypto_key_version_a.html
...
export interface DataGoogleKmsCryptoKeyVersionAConfig extends TerraformMetaArguments {
  readonly cryptoKey: string;
  readonly version?: number;
}
export class DataGoogleKmsCryptoKeyVersionPublicKeyA extends ComplexComputedList {
...
export class DataGoogleKmsCryptoKeyVersionA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleKmsCryptoKeyVersionAConfig) {
    super(scope, id, {
  ...
  public publicKey(index: string) {
    return new DataGoogleKmsCryptoKeyVersionPublicKeyA(this, 'public_key', index);
  }
