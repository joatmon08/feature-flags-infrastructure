// https://www.terraform.io/docs/providers/google-beta/r/google_game_services_game_server_cluster.html
...
export interface GoogleGameServicesGameServerClusterConfig extends TerraformMetaArguments {
...
export class GoogleGameServicesGameServerCluster extends TerraformResource {
  ...
  private _connectionInfo: GoogleGameServicesGameServerClusterConnectionInfo[];
  public get connectionInfo() {
    return this._connectionInfo;
  }
  public set connectionInfo(value: GoogleGameServicesGameServerClusterConnectionInfo[]) {
    this._connectionInfo = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleGameServicesGameServerClusterTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleGameServicesGameServerClusterTimeouts | undefined) {
