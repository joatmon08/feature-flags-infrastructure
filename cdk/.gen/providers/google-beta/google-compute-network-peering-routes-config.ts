// https://www.terraform.io/docs/providers/google-beta/r/google_compute_network_peering_routes_config.html
...
export interface GoogleComputeNetworkPeeringRoutesConfigConfig extends TerraformMetaArguments {
...
export class GoogleComputeNetworkPeeringRoutesConfig extends TerraformResource {
  ...
  private _timeouts?: GoogleComputeNetworkPeeringRoutesConfigTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleComputeNetworkPeeringRoutesConfigTimeouts | undefined) {
