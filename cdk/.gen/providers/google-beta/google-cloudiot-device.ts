// https://www.terraform.io/docs/providers/google-beta/r/google_cloudiot_device.html
...
export interface GoogleCloudiotDeviceConfig extends TerraformMetaArguments {
  ...
  /** credentials block */
  readonly credentials?: GoogleCloudiotDeviceCredentials[];
...
export class GoogleCloudiotDeviceConfig extends ComplexComputedList {
...
export class GoogleCloudiotDeviceLastErrorStatus extends ComplexComputedList {
...
export class GoogleCloudiotDeviceState extends ComplexComputedList {
...
export class GoogleCloudiotDevice extends TerraformResource {
  ...
  public config(index: string) {
    return new GoogleCloudiotDeviceConfig(this, 'config', index);
  }
  ...
  public lastErrorStatus(index: string) {
    return new GoogleCloudiotDeviceLastErrorStatus(this, 'last_error_status', index);
  }
  ...
  public state(index: string) {
    return new GoogleCloudiotDeviceState(this, 'state', index);
  }

  // credentials - computed: false, optional: true, required: false
  private _credentials?: GoogleCloudiotDeviceCredentials[];
  public get credentials() {
    return this._credentials;
  }
  public set credentials(value: GoogleCloudiotDeviceCredentials[] | undefined) {
    this._credentials = value;
  }

  // gateway_config - computed: false, optional: true, required: false
  private _gatewayConfig?: GoogleCloudiotDeviceGatewayConfig[];
  public get gatewayConfig() {
    return this._gatewayConfig;
  }
  public set gatewayConfig(value: GoogleCloudiotDeviceGatewayConfig[] | undefined) {
    this._gatewayConfig = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleCloudiotDeviceTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleCloudiotDeviceTimeouts | undefined) {
