// https://www.terraform.io/docs/providers/google-beta/r/data_google_container_engine_versions_a.html
...
export interface DataGoogleContainerEngineVersionsAConfig extends TerraformMetaArguments {
...
export class DataGoogleContainerEngineVersionsA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleContainerEngineVersionsAConfig = {}) {
    super(scope, id, {
