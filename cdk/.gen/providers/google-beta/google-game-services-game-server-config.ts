// https://www.terraform.io/docs/providers/google-beta/r/google_game_services_game_server_config.html
...
export interface GoogleGameServicesGameServerConfigConfig extends TerraformMetaArguments {
...
key-value pair. */
  ...
  /** fleet_configs block */
  readonly fleetConfigs: GoogleGameServicesGameServerConfigFleetConfigs[];
  /** scaling_configs block */
  readonly scalingConfigs?: GoogleGameServicesGameServerConfigScalingConfigs[];
  /** timeouts block */
...
https://agones.dev/site/docs/reference/fleetautoscaler/ */
  ...
  readonly name: string;
  /** schedules block */
  readonly schedules?: GoogleGameServicesGameServerConfigScalingConfigsSchedules[];
  /** selectors block */
  readonly selectors?: GoogleGameServicesGameServerConfigScalingConfigsSelectors[];
}
...
export class GoogleGameServicesGameServerConfig extends TerraformResource {
  ...
  private _fleetConfigs: GoogleGameServicesGameServerConfigFleetConfigs[];
  public get fleetConfigs() {
    return this._fleetConfigs;
  }
  public set fleetConfigs(value: GoogleGameServicesGameServerConfigFleetConfigs[]) {
    this._fleetConfigs = value;
  }

  // scaling_configs - computed: false, optional: true, required: false
  private _scalingConfigs?: GoogleGameServicesGameServerConfigScalingConfigs[];
  public get scalingConfigs() {
    return this._scalingConfigs;
  }
  public set scalingConfigs(value: GoogleGameServicesGameServerConfigScalingConfigs[] | undefined) {
    this._scalingConfigs = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleGameServicesGameServerConfigTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleGameServicesGameServerConfigTimeouts | undefined) {
