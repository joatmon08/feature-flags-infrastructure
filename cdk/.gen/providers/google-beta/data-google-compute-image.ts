// https://www.terraform.io/docs/providers/google-beta/r/data_google_compute_image_a.html
...
export interface DataGoogleComputeImageAConfig extends TerraformMetaArguments {
...
export class DataGoogleComputeImageA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleComputeImageAConfig = {}) {
    super(scope, id, {
