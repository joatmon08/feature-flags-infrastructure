// https://www.terraform.io/docs/providers/google-beta/r/google_pubsub_subscription.html
...
export interface GooglePubsubSubscriptionConfig extends TerraformMetaArguments {
...
export class GooglePubsubSubscription extends TerraformResource {
  ...
  private _deadLetterPolicy?: GooglePubsubSubscriptionDeadLetterPolicy[];
  public get deadLetterPolicy() {
    return this._deadLetterPolicy;
  }
  public set deadLetterPolicy(value: GooglePubsubSubscriptionDeadLetterPolicy[] | undefined) {
    this._deadLetterPolicy = value;
  }

  // expiration_policy - computed: false, optional: true, required: false
  private _expirationPolicy?: GooglePubsubSubscriptionExpirationPolicy[];
  public get expirationPolicy() {
    return this._expirationPolicy;
  }
  public set expirationPolicy(value: GooglePubsubSubscriptionExpirationPolicy[] | undefined) {
    this._expirationPolicy = value;
  }

  // push_config - computed: false, optional: true, required: false
  private _pushConfig?: GooglePubsubSubscriptionPushConfig[];
  public get pushConfig() {
    return this._pushConfig;
  }
  public set pushConfig(value: GooglePubsubSubscriptionPushConfig[] | undefined) {
    this._pushConfig = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GooglePubsubSubscriptionTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GooglePubsubSubscriptionTimeouts | undefined) {
