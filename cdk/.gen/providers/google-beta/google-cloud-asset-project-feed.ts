// https://www.terraform.io/docs/providers/google-beta/r/google_cloud_asset_project_feed.html
...
export interface GoogleCloudAssetProjectFeedConfig extends TerraformMetaArguments {
...
export class GoogleCloudAssetProjectFeed extends TerraformResource {
  ...
  private _feedOutputConfig: GoogleCloudAssetProjectFeedFeedOutputConfig[];
  public get feedOutputConfig() {
    return this._feedOutputConfig;
  }
  public set feedOutputConfig(value: GoogleCloudAssetProjectFeedFeedOutputConfig[]) {
    this._feedOutputConfig = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleCloudAssetProjectFeedTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleCloudAssetProjectFeedTimeouts | undefined) {
