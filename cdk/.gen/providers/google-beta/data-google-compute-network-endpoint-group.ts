// https://www.terraform.io/docs/providers/google-beta/r/data_google_compute_network_endpoint_group_a.html
...
export interface DataGoogleComputeNetworkEndpointGroupAConfig extends TerraformMetaArguments {
...
export class DataGoogleComputeNetworkEndpointGroupA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleComputeNetworkEndpointGroupAConfig = {}) {
    super(scope, id, {
