// https://www.terraform.io/docs/providers/google-beta/r/data_google_sql_database_instance_a.html
...
export interface DataGoogleSqlDatabaseInstanceAConfig extends TerraformMetaArguments {
  /** The name of the instance. If the name is left blank, Terraform will randomly generate one when the instance is first created. This is done because after a name is used, it cannot be reused for up to one week. */
  readonly name: string;
}
export class DataGoogleSqlDatabaseInstanceIpAddressA extends ComplexComputedList {
...
export class DataGoogleSqlDatabaseInstanceReplicaConfigurationA extends ComplexComputedList {
...
export class DataGoogleSqlDatabaseInstanceServerCaCertA extends ComplexComputedList {
...
export class DataGoogleSqlDatabaseInstanceSettingsBackupConfigurationA extends ComplexComputedList {
...
export class DataGoogleSqlDatabaseInstanceSettingsDatabaseFlagsA extends ComplexComputedList {
...
export class DataGoogleSqlDatabaseInstanceSettingsIpConfigurationAuthorizedNetworksA extends ComplexComputedList {
...
export class DataGoogleSqlDatabaseInstanceSettingsIpConfigurationA extends ComplexComputedList {
...
export class DataGoogleSqlDatabaseInstanceSettingsLocationPreferenceA extends ComplexComputedList {
...
export class DataGoogleSqlDatabaseInstanceSettingsMaintenanceWindowA extends ComplexComputedList {
...
export class DataGoogleSqlDatabaseInstanceSettingsA extends ComplexComputedList {
...
export class DataGoogleSqlDatabaseInstanceA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleSqlDatabaseInstanceAConfig) {
    super(scope, id, {
  ...
  // encryption_key_name - computed: true, optional: false, required: true
  ...
  public ipAddress(index: string) {
    return new DataGoogleSqlDatabaseInstanceIpAddressA(this, 'ip_address', index);
  }
  ...
  public replicaConfiguration(index: string) {
    return new DataGoogleSqlDatabaseInstanceReplicaConfigurationA(this, 'replica_configuration', index);
  }
  ...
  public serverCaCert(index: string) {
    return new DataGoogleSqlDatabaseInstanceServerCaCertA(this, 'server_ca_cert', index);
  }
  ...
  public settings(index: string) {
    return new DataGoogleSqlDatabaseInstanceSettingsA(this, 'settings', index);
  }
