// https://www.terraform.io/docs/providers/google-beta/r/google_cloudiot_registry.html
...
export interface GoogleCloudiotRegistryConfig extends TerraformMetaArguments {
...
If it is not provided, the provider region is used. */
  ...
  /** credentials block */
  readonly credentials?: GoogleCloudiotRegistryCredentials[];
  /** event_notification_configs block */
  readonly eventNotificationConfigs?: GoogleCloudiotRegistryEventNotificationConfigs[];
  /** timeouts block */
...
export class GoogleCloudiotRegistry extends TerraformResource {
  ...
  private _credentials?: GoogleCloudiotRegistryCredentials[];
  public get credentials() {
    return this._credentials;
  }
  public set credentials(value: GoogleCloudiotRegistryCredentials[] | undefined) {
    this._credentials = value;
  }

  // event_notification_configs - computed: false, optional: true, required: false
  private _eventNotificationConfigs?: GoogleCloudiotRegistryEventNotificationConfigs[];
  public get eventNotificationConfigs() {
    return this._eventNotificationConfigs;
  }
  public set eventNotificationConfigs(value: GoogleCloudiotRegistryEventNotificationConfigs[] | undefined) {
    this._eventNotificationConfigs = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleCloudiotRegistryTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleCloudiotRegistryTimeouts | undefined) {
