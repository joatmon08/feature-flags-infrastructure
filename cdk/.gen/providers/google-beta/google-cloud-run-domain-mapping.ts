// https://www.terraform.io/docs/providers/google-beta/r/google_cloud_run_domain_mapping.html
...
export interface GoogleCloudRunDomainMappingConfig extends TerraformMetaArguments {
...
export class GoogleCloudRunDomainMappingStatusConditions extends ComplexComputedList {
...
export class GoogleCloudRunDomainMappingStatusResourceRecords extends ComplexComputedList {
...
export class GoogleCloudRunDomainMappingStatus extends ComplexComputedList {
...
export class GoogleCloudRunDomainMapping extends TerraformResource {
  ...
  public status(index: string) {
    return new GoogleCloudRunDomainMappingStatus(this, 'status', index);
  }

  // metadata - computed: false, optional: false, required: true
  private _metadata: GoogleCloudRunDomainMappingMetadata[];
  public get metadata() {
    return this._metadata;
  }
  public set metadata(value: GoogleCloudRunDomainMappingMetadata[]) {
    this._metadata = value;
  }

  // spec - computed: false, optional: false, required: true
  private _spec: GoogleCloudRunDomainMappingSpec[];
  public get spec() {
    return this._spec;
  }
  public set spec(value: GoogleCloudRunDomainMappingSpec[]) {
    this._spec = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleCloudRunDomainMappingTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleCloudRunDomainMappingTimeouts | undefined) {
