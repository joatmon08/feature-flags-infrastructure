// https://www.terraform.io/docs/providers/google-beta/r/google_cloud_scheduler_job.html
...
export interface GoogleCloudSchedulerJobConfig extends TerraformMetaArguments {
...
export class GoogleCloudSchedulerJob extends TerraformResource {
  ...
  private _appEngineHttpTarget?: GoogleCloudSchedulerJobAppEngineHttpTarget[];
  public get appEngineHttpTarget() {
    return this._appEngineHttpTarget;
  }
  public set appEngineHttpTarget(value: GoogleCloudSchedulerJobAppEngineHttpTarget[] | undefined) {
    this._appEngineHttpTarget = value;
  }

  // http_target - computed: false, optional: true, required: false
  private _httpTarget?: GoogleCloudSchedulerJobHttpTarget[];
  public get httpTarget() {
    return this._httpTarget;
  }
  public set httpTarget(value: GoogleCloudSchedulerJobHttpTarget[] | undefined) {
    this._httpTarget = value;
  }

  // pubsub_target - computed: false, optional: true, required: false
  private _pubsubTarget?: GoogleCloudSchedulerJobPubsubTarget[];
  public get pubsubTarget() {
    return this._pubsubTarget;
  }
  public set pubsubTarget(value: GoogleCloudSchedulerJobPubsubTarget[] | undefined) {
    this._pubsubTarget = value;
  }

  // retry_config - computed: false, optional: true, required: false
  private _retryConfig?: GoogleCloudSchedulerJobRetryConfig[];
  public get retryConfig() {
    return this._retryConfig;
  }
  public set retryConfig(value: GoogleCloudSchedulerJobRetryConfig[] | undefined) {
    this._retryConfig = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleCloudSchedulerJobTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleCloudSchedulerJobTimeouts | undefined) {
