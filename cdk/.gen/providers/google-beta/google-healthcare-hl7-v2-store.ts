// https://www.terraform.io/docs/providers/google-beta/r/google_healthcare_hl7_v2_store.html
...
export interface GoogleHealthcareHl7V2StoreConfig extends TerraformMetaArguments {
...
** Changing this property may recreate the Hl7v2 store (removing all data) ** */
  ...
  readonly notificationConfigs?: GoogleHealthcareHl7V2StoreNotificationConfigs[];
  /** parser_config block */
...
export class GoogleHealthcareHl7V2Store extends TerraformResource {
  ...
  private _notificationConfig?: GoogleHealthcareHl7V2StoreNotificationConfig[];
  public get notificationConfig() {
    return this._notificationConfig;
  }
  public set notificationConfig(value: GoogleHealthcareHl7V2StoreNotificationConfig[] | undefined) {
    this._notificationConfig = value;
  }

  // notification_configs - computed: false, optional: true, required: false
  private _notificationConfigs?: GoogleHealthcareHl7V2StoreNotificationConfigs[];
  public get notificationConfigs() {
    return this._notificationConfigs;
  }
  public set notificationConfigs(value: GoogleHealthcareHl7V2StoreNotificationConfigs[] | undefined) {
    this._notificationConfigs = value;
  }

  // parser_config - computed: false, optional: true, required: false
  private _parserConfig?: GoogleHealthcareHl7V2StoreParserConfig[];
  public get parserConfig() {
    return this._parserConfig;
  }
  public set parserConfig(value: GoogleHealthcareHl7V2StoreParserConfig[] | undefined) {
    this._parserConfig = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleHealthcareHl7V2StoreTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleHealthcareHl7V2StoreTimeouts | undefined) {
