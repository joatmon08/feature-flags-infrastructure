// https://www.terraform.io/docs/providers/google-beta/r/google_compute_instance_group.html
...
export interface GoogleComputeInstanceGroupConfig extends TerraformMetaArguments {
  ...
  /** named_port block */
  readonly namedPort?: GoogleComputeInstanceGroupNamedPort[];
  /** timeouts block */
...
export class GoogleComputeInstanceGroup extends TerraformResource {
  ...
  private _namedPort?: GoogleComputeInstanceGroupNamedPort[];
  public get namedPort() {
    return this._namedPort;
  }
  public set namedPort(value: GoogleComputeInstanceGroupNamedPort[] | undefined) {
    this._namedPort = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleComputeInstanceGroupTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleComputeInstanceGroupTimeouts | undefined) {
