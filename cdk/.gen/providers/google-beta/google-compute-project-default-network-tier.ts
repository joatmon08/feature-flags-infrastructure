// https://www.terraform.io/docs/providers/google-beta/r/google_compute_project_default_network_tier.html
...
export interface GoogleComputeProjectDefaultNetworkTierConfig extends TerraformMetaArguments {
...
export class GoogleComputeProjectDefaultNetworkTier extends TerraformResource {
  ...
  private _timeouts?: GoogleComputeProjectDefaultNetworkTierTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleComputeProjectDefaultNetworkTierTimeouts | undefined) {
