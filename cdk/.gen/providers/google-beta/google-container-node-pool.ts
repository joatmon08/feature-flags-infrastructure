// https://www.terraform.io/docs/providers/google-beta/r/google_container_node_pool.html
...
export interface GoogleContainerNodePoolConfig extends TerraformMetaArguments {
...
export interface GoogleContainerNodePoolNodeConfig {
  ...
  readonly guestAccelerator?: GoogleContainerNodePoolNodeConfigGuestAccelerator[];
  ...
  readonly taint?: GoogleContainerNodePoolNodeConfigTaint[];
...
export class GoogleContainerNodePool extends TerraformResource {
  ...
  private _autoscaling?: GoogleContainerNodePoolAutoscaling[];
  public get autoscaling() {
    return this._autoscaling;
  }
  public set autoscaling(value: GoogleContainerNodePoolAutoscaling[] | undefined) {
    this._autoscaling = value;
  }

  // management - computed: false, optional: true, required: false
  private _management?: GoogleContainerNodePoolManagement[];
  public get management() {
    return this._management;
  }
  public set management(value: GoogleContainerNodePoolManagement[] | undefined) {
    this._management = value;
  }

  // node_config - computed: false, optional: true, required: false
  private _nodeConfig?: GoogleContainerNodePoolNodeConfig[];
  public get nodeConfig() {
    return this._nodeConfig;
  }
  public set nodeConfig(value: GoogleContainerNodePoolNodeConfig[] | undefined) {
    this._nodeConfig = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleContainerNodePoolTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleContainerNodePoolTimeouts | undefined) {
    this._timeouts = value;
  }

  // upgrade_settings - computed: false, optional: true, required: false
  private _upgradeSettings?: GoogleContainerNodePoolUpgradeSettings[];
  public get upgradeSettings() {
    return this._upgradeSettings;
  }
  public set upgradeSettings(value: GoogleContainerNodePoolUpgradeSettings[] | undefined) {
