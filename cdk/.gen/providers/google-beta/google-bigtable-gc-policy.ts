// https://www.terraform.io/docs/providers/google-beta/r/google_bigtable_gc_policy.html
...
export interface GoogleBigtableGcPolicyConfig extends TerraformMetaArguments {
  ...
  /** max_version block */
  readonly maxVersion?: GoogleBigtableGcPolicyMaxVersion[];
}
...
export class GoogleBigtableGcPolicy extends TerraformResource {
  ...
  private _maxAge?: GoogleBigtableGcPolicyMaxAge[];
  public get maxAge() {
    return this._maxAge;
  }
  public set maxAge(value: GoogleBigtableGcPolicyMaxAge[] | undefined) {
    this._maxAge = value;
  }

  // max_version - computed: false, optional: true, required: false
  private _maxVersion?: GoogleBigtableGcPolicyMaxVersion[];
  public get maxVersion() {
    return this._maxVersion;
  }
  public set maxVersion(value: GoogleBigtableGcPolicyMaxVersion[] | undefined) {
