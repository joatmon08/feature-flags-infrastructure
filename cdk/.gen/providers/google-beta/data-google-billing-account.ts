// https://www.terraform.io/docs/providers/google-beta/r/data_google_billing_account_a.html
...
export interface DataGoogleBillingAccountAConfig extends TerraformMetaArguments {
...
export class DataGoogleBillingAccountA extends TerraformDataSource {

  // ===========
  // INITIALIZER
  // ===========

  public constructor(scope: Construct, id: string, config: DataGoogleBillingAccountAConfig = {}) {
    super(scope, id, {
