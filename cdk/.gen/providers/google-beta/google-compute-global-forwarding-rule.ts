// https://www.terraform.io/docs/providers/google-beta/r/google_compute_global_forwarding_rule.html
...
export interface GoogleComputeGlobalForwardingRuleConfig extends TerraformMetaArguments {
...
are valid. */
  ...
  readonly metadataFilters?: GoogleComputeGlobalForwardingRuleMetadataFilters[];
  /** timeouts block */
...
provided metadata. Possible values: ["MATCH_ANY", "MATCH_ALL"] */
  ...
  /** filter_labels block */
  readonly filterLabels: GoogleComputeGlobalForwardingRuleMetadataFiltersFilterLabels[];
}
...
export class GoogleComputeGlobalForwardingRule extends TerraformResource {
  ...
  private _metadataFilters?: GoogleComputeGlobalForwardingRuleMetadataFilters[];
  public get metadataFilters() {
    return this._metadataFilters;
  }
  public set metadataFilters(value: GoogleComputeGlobalForwardingRuleMetadataFilters[] | undefined) {
    this._metadataFilters = value;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts?: GoogleComputeGlobalForwardingRuleTimeouts;
  public get timeouts() {
    return this._timeouts;
  }
  public set timeouts(value: GoogleComputeGlobalForwardingRuleTimeouts | undefined) {
